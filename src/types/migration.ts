...
export function isAlbumWithStats(entity: EntityWithStats): entity is AlbumComplete {
  return 'description' in entity &&
         ...
         !('path' in entity); // Distinguir de Folder
}
...
export function isAudioWithStats(entity: EntityWithStats): entity is AudioComplete {
  return 'duration' in entity &&
         'bitrate' in entity &&
         'format' in entity &&
         !('fps' in entity); // Distinguir de Video
}
...
export function isDocumentWithStats(entity: EntityWithStats): entity is DocumentComplete {
  return 'content' in entity &&
         'format' in entity &&
         'mimeType' in entity &&
         !('bitrate' in entity); // Distinguir de Audio
}
...
export function isTagWithStats(entity: EntityWithStats): entity is TagComplete {
  return 'color' in entity &&
         ...
         !('description' in entity); // Tags no tienen description
}
...
export function isPropertyWithStats(entity: EntityWithStats): entity is PropertyComplete {
  return 'propertyType' in entity &&
         'value' in entity &&
         !('values' in entity); // Distinguir de Wildcard
}
 ...
 */
export async function migrateFileItemsToEntityWithStats(
  fileItems: any[]
): Promise<EntityWithStats[]> {
