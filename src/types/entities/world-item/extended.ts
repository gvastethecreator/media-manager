 ...
 */
export interface ParsedWorldItem extends Omit<WorldItemBase, 'stats' | 'attributes' | 'effects' | 'properties' | 'requirements' | 'filters'> {
 ...
 */
export interface ParsedWorldItemWithRelations extends Omit<WorldItemWithRelations, keyof ParsedWorldItem>, ParsedWorldItem {}
 ...
 */
export interface WorldItemExtended extends Omit<WorldItemBase, 'stats' | 'attributes' | 'effects' | 'properties' | 'requirements' | 'filters'> {
