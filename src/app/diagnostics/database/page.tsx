      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Esta herramienta le ayudará a diagnosticar problemas comunes con la conexión
            a la base de datos y la estructura de tablas.
          </p>
        </div>
        ...
        <div className="mt-8 text-sm bg-muted p-4 rounded-md">
          ...
          <p>
            Si está experimentando errores al cargar carpetas o imágenes, es posible que haya
            problemas con la conexión a la base de datos o con la estructura de las tablas.
            Esta herramienta ejecuta pruebas de diagnóstico para ayudar a identificar la causa del problema.
          </p>
          <p className="mt-2">
            Si los diagnósticos muestran errores, verifique:
          </p>
