		...
		const notes = [
			{
				...
				content:
					'Comenzar en una posada. El grupo es contratado para investigar desapariciones en el bosque cercano. Pistas llevan a un antiguo templo.',
				category: 'campaign',
			...
			},
			{
				...
				content:
					'Buscar referencias de guerreros con armadura ligera, preferentemente con estilo celta o vikingo. Paleta de colores: verdes oscuros y marrones.',
				category: 'reference',
			...
			},
			{
				...
				content:
					'La magia proviene de cristales elementales. Cada hechicero debe sintonizarse con un tipo específico. Limitaciones: distancia al cristal fuente, afinidad elemental.',
