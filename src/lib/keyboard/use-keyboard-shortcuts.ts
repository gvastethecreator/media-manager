...
import { keyboardShortcutManager, type KeyboardShortcutConfig, type ShortcutHandler } from './keyboard-shortcut-manager';
...
export const useKeyboardShortcuts = (
  ...
  useEffect(() => {
    ...
    const handleKeyDown = keyboardShortcutManager.handleKeyDown;
