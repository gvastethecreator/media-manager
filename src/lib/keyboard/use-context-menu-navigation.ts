...
export const useContextMenuNavigation = (
  ...
  useEffect(() => {
    ...
    register(
      { key: 'arrowup', modifiers: [], context: 'context-menu', description: 'Navegar arriba', action: 'context-menu-up' },
      navigateUp
    );

    register(
      { key: 'arrowdown', modifiers: [], context: 'context-menu', description: 'Navegar abajo', action: 'context-menu-down' },
      navigateDown
    );

    register(
      { key: 'enter', modifiers: [], context: 'context-menu', description: 'Ejecutar acción', action: 'context-menu-execute' },
      executeSelected
    );

    register(
      { key: 'escape', modifiers: [], context: 'context-menu', description: 'Cerrar menú', action: 'context-menu-close' },
      closeMenu
    );
