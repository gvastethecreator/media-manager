 ...
 */
export function generateClipPath(shape: string, size = 100): string {
...
export class MorphEngine {
	 ...
	 */
	register(id: string, initialShape = 'square'): void {
		this.states.set(id, {
	 ...
	 */
	async morphTo(element: HTMLElement, toShape: string, config: Partial<MorphConfig> = {}): Promise<void> {
 ...
 */
export async function createLiquidMorph(
	element: HTMLElement,
	intensity = 0.3,
	duration = 1000
