...
import { customEasings, contextualEasings } from './easings';
import type { EnterConfig, ExitConfig, TransitionDirection } from '../types';
 ...
 */
export function getDirectionalEnterPreset(
 ...
 */
export function getDirectionalExitPreset(
  direction: TransitionDirection,
  distance: number = 50
): AnimationPreset {
 ...
 */
export function getAnimeConfig(
  preset: AnimationPreset,
