 ...
 */
export const VALID_DATA_TYPES = ['string', 'number', 'boolean', 'object', 'array', 'date'] as const;

/**
 * 📊 Campos de ordenamiento válidos
 */
export const VALID_SORT_FIELDS = ['name', 'createdAt', 'updatedAt', 'addedAt', 'level', 'category'] as const;
 ...
 */
export const PREDEFINED_CATEGORIES = ['general', 'personal', 'work', 'archive', 'favorite'] as const;
