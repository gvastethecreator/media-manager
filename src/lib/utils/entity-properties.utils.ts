...
export function getEntitySize(entity: AnyEntityWithStats): number {
  ...
  if ('statistics' in entity && entity.statistics && 'size' in entity.statistics && typeof entity.statistics.size === 'number') {
 ...
 */
export function getEntityProperty<T = any>(entity: AnyEntityWithStats, property: string, defaultValue?: T): T | undefined {
