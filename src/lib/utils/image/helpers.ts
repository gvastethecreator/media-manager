...
// Usar formatBytes desde allí: import { formatBytes } from '@/lib/utils/format.utils';
 ...
 */
export function generateThumbnailUrl(image: Image | string, width?: number, height?: number): string {
