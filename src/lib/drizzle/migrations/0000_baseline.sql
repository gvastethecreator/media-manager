...
--> statement-breakpoint
CREATE INDEX `feature_status_idx` ON `dev_features` (`status`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `alert_level_idx` ON `server_alerts` (`level`);--> statement-breakpoint
CREATE INDEX `alert_service_idx` ON `server_alerts` (`service`);--> statement-breakpoint
CREATE INDEX `alert_resolved_idx` ON `server_alerts` (`resolved`);--> statement-breakpoint
...
CREATE INDEX `_VideoToWorldItem_B_index` ON `_VideoToWorldItem` (`B`);--> statement-breakpoint
CREATE TABLE `Video` (
	`id` text PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
	`description` text,
