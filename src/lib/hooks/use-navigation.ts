      ...
      switch (store.currentContext) {
        ...
        case 'collection':
          breadcrumbs.push(
            ...
            { name: store.currentCollection?.name || 'Colección', path: `/collections/${store.currentCollectionId}`, isActive: true }
          );
          break;
        case 'tag':
          breadcrumbs.push(
        ...
        case 'character':
          breadcrumbs.push(
            ...
            { name: store.currentCharacter?.name || 'Personaje', path: `/characters/${store.currentCharacterId}`, isActive: true }
          );
          break;
        case 'place':
          breadcrumbs.push(
        ...
        case 'worldItem':
          breadcrumbs.push(
            ...
            { name: store.currentWorldItem?.name || 'Elemento', path: `/world-items/${store.currentWorldItemId}`, isActive: true }
          );
          break;
        case 'all':
          breadcrumbs.push(
            { name: 'Todas las imágenes', path: '/images/all', isActive: true }
          );
          break;
      }
