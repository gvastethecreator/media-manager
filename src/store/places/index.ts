...
export const usePlacesStore = create<PlacesState>()(
  persist(
    (set, get) => ({
      ...
      // Acciones: selección
      selectPlace: (id) => set((state) => ({
        selectedPlaceIds: [...state.selectedPlaceIds, id]
      })),

      deselectPlace: (id) => set((state) => ({
        selectedPlaceIds: state.selectedPlaceIds.filter(placeId => placeId !== id)
      })),

      setSelectedPlaceIds: (ids) => set({
      ...
      togglePlaceSelection: (id) => set((state) => ({
