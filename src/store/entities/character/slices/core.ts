...
> = (set, get) => ({
    ...
    addCharacter: (character: CharacterBase | CharacterExtended) => {
        set(state => {
            ...
            const characterExtended = 'isSelected' in characterWithId
    ...
    addRelationship: (
        ...
        set(state => {
            ...
            const updatedRelationships = [
                ...currentRelationships.filter(r => r.characterId !== targetId),
                newRelationship
            ];
    ...
    removeRelationship: (characterId: string, targetId: string) => {
        set(state => {
            ...
            const updatedRelationships = character.parsedRelationships.filter(
