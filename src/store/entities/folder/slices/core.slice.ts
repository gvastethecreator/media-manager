 ...
 */
export const createFolderCoreSlice: StateCreator<
  FolderStore,
  [],
  [],
  FolderCoreState & FolderCoreActions
> = (set, get) => ({
  // Estado inicial
  items: [],
  selected: null,
  ...
  updateFolder: async (id, data) => {
    try {
      ...
      set(state => {
        ...
        const selected = state.selected && state.selected.id === updatedFolder.id
          ? updatedFolder
          : state.selected;
