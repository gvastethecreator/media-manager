...
import { OperationQueue } from './unified-file-manager-queue';
import type { UnifiedFileManagerState } from './unified-file-manager-types';

// Re-exports para compatibilidad backward
export { OperationQueue } from './unified-file-manager-queue';
export type {
	BaseEntity,
	CollectionEntity,
	EntityWithEmoji,
	NavigationContext,
	TagEntity,
	UnifiedFileManagerState,
} from './unified-file-manager-types';
