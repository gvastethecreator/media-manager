 ...
 */
export function validateRequiredProps(obj: any, requiredProps: string[]): { isValid: boolean; errors: string[] } {
	const errors: string[] = [];
 ...
 */
export function validateEntityType(obj: any, entityType: string): { isValid: boolean; messages: string[] } {
