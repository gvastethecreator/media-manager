							...
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleOptionChange("enableLazyLoading", checked)
									}
								/>
							</div>
						</div>
						...
						<div className="space-y-1.5">
							<div className="flex items-center justify-between">
								...
								>
									...
									<TooltipProvider>
										<Tooltip>
											...
											<TooltipContent className="text-[10px] max-w-[180px]">
												Optimiza automáticamente las imágenes para mejorar el
												rendimiento
											</TooltipContent>
										</Tooltip>
									</TooltipProvider>
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleOptionChange("enableImageOptimization", checked)
									}
								/>
							</div>
						</div>
						...
						<div className="space-y-1.5">
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleOptionChange("enableVirtualization", checked)
									}
								/>
							</div>
						</div>
						...
						<div className="space-y-1.5">
							<div className="flex items-center justify-between">
								...
								>
									...
									<TooltipProvider>
										<Tooltip>
											...
											<TooltipContent className="text-[10px] max-w-[180px]">
												Almacena en caché las tarjetas para mejorar el
												rendimiento
											</TooltipContent>
										</Tooltip>
									</TooltipProvider>
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleOptionChange("enableCaching", checked)
									}
								/>
							</div>
						</div>
						...
						<div className="grid grid-cols-2 gap-3 pt-1.5">
							<div className="space-y-1.5">
								...
								<Slider
									...
									onValueChange={(value) =>
										handleOptionChange("animationDuration", value[0])
									}
							...
							<div className="space-y-1.5">
								...
								<Slider
									...
									onValueChange={(value) =>
										handleOptionChange("transitionDuration", value[0])
									}
									className="cursor-pointer"
								/>
							</div>
						...
						<div className="pt-2">
							<div className="space-y-1.5">
								...
								<Slider
									...
									onValueChange={(value) =>
										handleOptionChange("throttleDelay", value[0])
									}
									className="cursor-pointer"
								/>
							</div>
