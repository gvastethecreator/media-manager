		...
		>
			...
			<CardContent className="p-2.5 space-y-3">
							...
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleOptionChange("enable3DEffect", checked)
									}
								/>
							</div>
						</div>
						...
						<div className="space-y-1.5">
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleOptionChange("enableHolographicEffect", checked)
									}
								/>
							</div>
						</div>
						...
						<div className="space-y-1.5">
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleOptionChange("enableGlowEffect", checked)
									}
								/>
							</div>
						</div>
						...
						<div className="space-y-1.5">
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleOptionChange("enableScanlines", checked)
									}
								/>
							</div>
						</div>
				...
				<div
					className={cn(
						"space-y-3",
						!cardOptions.enable3DEffect && "opacity-50 pointer-events-none"
					)}
				>
					<div className="grid grid-cols-2 gap-2">
						<div className="space-y-1.5">
							...
							<Slider
								...
								onValueChange={(value) =>
									handleOptionChange("maxRotation", value[0])
								}
						...
						<div className="space-y-1.5">
							...
							<Slider
								...
								onValueChange={(value) =>
									handleOptionChange("hoverLiftHeight", value[0])
								}
								className="cursor-pointer"
							/>
						</div>
