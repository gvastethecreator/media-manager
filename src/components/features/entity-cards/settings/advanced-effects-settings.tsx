...
const AnimatedOption = ({
	...
	return (
		...
		>
			<AccordionTrigger
				className={cn("px-3 py-2 hover:no-underline", value && colorScheme.bg)}
			>
...
export function AdvancedEffectsSettings({
	...
	const scanlinesOpacity =
		cardOptions.scanlinesOptions?.opacity !== undefined
			? cardOptions.scanlinesOptions.opacity * 100
			: 20;
	const scanlinesSpacing = cardOptions.scanlinesOptions?.spacing || 4;
	const scanlinesDirection =
		cardOptions.scanlinesOptions?.direction || "horizontal";
	const scanlinesAnimate = cardOptions.scanlinesOptions?.animate || false;

	// Valores actuales para grano
	const grainIntensity =
		cardOptions.grainOptions?.intensity !== undefined
			? cardOptions.grainOptions.intensity * 100
			: 15;
	const grainDensity =
		cardOptions.grainOptions?.density !== undefined
			? cardOptions.grainOptions.density * 100
			: 60;
	...
	const borderAnimationType =
		cardOptions.borderOptions?.animationType || "flow";
					...
					<TooltipProvider>
						<Tooltip>
							...
							<TooltipContent side="top" className="text-[10px] max-w-[180px]">
								Configura efectos visuales adicionales para personalizar la
			...
			<CardContent className="p-2.5 pt-1 space-y-1">
				<Accordion type="multiple" className="w-full">
						...
						<div className="space-y-3">
							...
							<div className="grid gap-1.5">
								...
								<Slider
									...
									onValueChange={([value]) =>
										handleScanlinesOptionChange("opacity", value / 100)
									}
								/>
							</div>
							...
							<div className="grid gap-1.5">
								...
								<Slider
									...
									onValueChange={([value]) =>
										handleScanlinesOptionChange("spacing", value)
									}
								/>
							</div>
							...
							<div className="grid gap-1.5">
								...
								<Select
									...
									onValueChange={(value) =>
										handleScanlinesOptionChange("direction", value)
									}
								>
							...
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleScanlinesOptionChange("animate", checked)
									}
								/>
							</div>
						</div>
						...
						<div className="space-y-3">
							...
							<div className="grid gap-1.5">
								...
								<Slider
									...
									onValueChange={([value]) =>
										handleGrainOptionChange("intensity", value / 100)
									}
								/>
							</div>
							...
							<div className="grid gap-1.5">
								...
								<Slider
									...
									value={[grainDensity]}
									onValueChange={([value]) =>
										handleGrainOptionChange("density", value / 100)
									}
								/>
							</div>
							...
							<div className="grid gap-1.5">
								...
								<Select
									value={grainNoise}
									onValueChange={(value) =>
										handleGrainOptionChange("noise", value)
									}
								>
									<SelectTrigger className="h-8 text-xs">
							...
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleGrainOptionChange("animated", checked)
									}
								/>
							</div>
						</div>
					...
					<AnimatedOption
						...
						onChange={(value) =>
							handleOptionChange("enableAnimatedBorder", value)
						}
						...
						<div className="space-y-3">
							...
							<div className="grid gap-1.5">
								...
								<Slider
									...
									value={[borderWidth]}
									onValueChange={([value]) =>
										handleBorderOptionChange("width", value)
									}
								/>
							</div>
							...
							<div className="grid gap-1.5">
								...
								<Select
									value={borderPattern}
									onValueChange={(value) =>
										handleBorderOptionChange("pattern", value)
									}
								>
									<SelectTrigger className="h-8 text-xs">
							...
							<div className="grid gap-1.5">
								...
								<Select
									...
									onValueChange={(value) =>
										handleBorderOptionChange("animationType", value)
									}
								>
									<SelectTrigger className="h-8 text-xs">
