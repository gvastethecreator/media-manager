		...
		<div className="w-full space-y-3">
			<Tabs defaultValue="effects" className="w-full">
				<TabsList className="grid grid-cols-2 mb-3 h-8">
					...
					<TabsTrigger value="colors" className="text-xs flex items-center gap-1.5 h-full">
				...
				<TabsContent value="effects" className="space-y-3">
					<div
						className={cn('rounded-md border p-2.5 space-y-2', configColors.effects.border, configColors.effects.bg)}
					>
						<div className="flex items-center justify-between mb-1">
							<Label className="text-[11px] font-medium flex items-center gap-1.5">
								<Sparkles className={cn('h-3 w-3', configColors.effects.text)} />
								Efectos Visuales
							</Label>
						</div>
						...
						<div className="grid grid-cols-2 gap-2">
							<div className="space-y-1.5">
								<div className="flex items-center space-x-2">
									...
									/>
									<Label htmlFor="enable3DEffect" className="text-[11px] flex items-center gap-1.5">
								...
								<div className="flex items-center space-x-2">
									...
									/>
									<Label htmlFor="enableHolographicEffect" className="text-[11px] flex items-center gap-1.5">
								...
								<div className="flex items-center space-x-2">
									...
									/>
									<Label htmlFor="enableScanlines" className="text-[11px] flex items-center gap-1.5">
							...
							<div className="space-y-1.5">
								<div className="flex items-center space-x-2">
									...
									/>
									<Label htmlFor="enableBorderEffect" className="text-[11px] flex items-center gap-1.5">
								...
								<div className="flex items-center space-x-2">
									...
									/>
									<Label htmlFor="enableAnimatedBorder" className="text-[11px] flex items-center gap-1.5">
										<Layers className="h-3 w-3 text-violet-500" />
										Borde Animado
									</Label>
								</div>
								...
								<div className="flex items-center space-x-2">
									...
									/>
									<Label htmlFor="enableGlowEffect" className="text-[11px] flex items-center gap-1.5">
								...
								<div className="flex items-center space-x-2">
									...
									/>
									<Label htmlFor="enableGrainEffect" className="text-[11px] flex items-center gap-1.5">
										<Layers className="h-3 w-3 text-violet-500" />
										Efecto Grano
									</Label>
								</div>
					...
					>
						<div className="flex items-center justify-between mb-1">
							<Label className="text-[11px] font-medium flex items-center gap-1.5">
								<Rotate3d className={cn('h-3 w-3', configColors.effects.text)} />
							...
							<TooltipProvider>
								<Tooltip>
									...
									<TooltipContent className="text-[10px] max-w-[180px]" side="top">
										Estos ajustes controlan la percepción de profundidad y movimiento de la tarjeta.
									</TooltipContent>
								</Tooltip>
							</TooltipProvider>
						</div>
						...
						<div className="grid grid-cols-2 gap-2">
							...
							<div className="space-y-1.5">
								<div className="flex items-center justify-between">
									...
									<span className="text-[10px] font-mono text-muted-foreground">{localOptions.maxRotation ?? 15}°</span>
								</div>
								<Slider
									id="maxRotation"
				...
				<TabsContent value="colors" className="space-y-3">
					<div className={cn('rounded-md border p-2.5 space-y-2', configColors.colors.border, configColors.colors.bg)}>
						<div className="flex items-center justify-between mb-1">
							<Label className="text-[11px] font-medium flex items-center gap-1.5">
							...
							<TooltipProvider>
								<Tooltip>
									...
									<TooltipContent className="text-[10px] max-w-[180px]" side="top">
										Los colores deben ingresarse en formato RGB separados por comas (ej. 255, 0, 128).
									</TooltipContent>
								</Tooltip>
							</TooltipProvider>
						</div>
						...
						<div className="space-y-2">
							<div className="space-y-1.5">
								<Label htmlFor="primaryColor" className="text-[11px] flex items-center gap-1.5">
									Color Primario
								</Label>
							...
							<div className="space-y-1.5">
								<Label htmlFor="secondaryColor" className="text-[11px] flex items-center gap-1.5">
									Color Secundario
								</Label>
								<div className="flex gap-2 items-center">
									<Input
			...
			<div className="flex justify-end gap-1.5 mt-3">
				{onClose && (
					<Button variant="outline" size="sm" onClick={onClose} className="h-7 text-xs px-2 flex items-center gap-1">
						<XCircle className="h-3 w-3" />
						Cancelar
					</Button>
				)}
				<Button size="sm" onClick={applyChanges} className="h-7 text-xs px-3 flex items-center gap-1">
