		...
		<div className="w-full space-y-3">
			<Tabs defaultValue="holographic" className="w-full">
				<TabsList className="flex flex-wrap w-full h-8 gap-1 p-0.5">
					<TabsTrigger value="holographic" className="text-[10px] h-full flex items-center gap-1">
						<Waves className="h-3 w-3" />
						Holográfico
					</TabsTrigger>
					<TabsTrigger value="scanlines" className="text-[10px] h-full flex items-center gap-1">
						<GanttChartSquare className="h-3 w-3" />
						Líneas
					</TabsTrigger>
					<TabsTrigger value="glow" className="text-[10px] h-full flex items-center gap-1">
						<FlameKindling className="h-3 w-3" />
						Resplandor
					</TabsTrigger>
					<TabsTrigger value="border" className="text-[10px] h-full flex items-center gap-1">
						<Braces className="h-3 w-3" />
						Borde
					</TabsTrigger>
					<TabsTrigger value="grain" className="text-[10px] h-full flex items-center gap-1">
					...
					>
						<div className="grid grid-cols-2 gap-2">
							<div className="space-y-1.5">
								<Label htmlFor="holographic-pattern" className="text-[11px] flex items-center gap-1.5">
									<Waves className={cn('h-3 w-3', effectColors.holographic.text)} />
									Tipo de Patrón
								</Label>
								<Select
							...
							<div className="space-y-1.5">
								<div className="flex items-center justify-between">
									<Label htmlFor="holographic-intensity" className="text-[11px]">
										Intensidad
									</Label>
						...
						<div className="grid grid-cols-2 gap-2">
							...
							<div className="space-y-1.5">
								<div className="flex items-center justify-between">
									<Label htmlFor="holographic-visible-hover" className="text-[11px]">
										Solo al pasar
									</Label>
									<Switch
				...
				<TabsContent value="scanlines" className="space-y-3 mt-2">
					...
					>
						...
						<div className="grid grid-cols-2 gap-2">
							<div className="space-y-1.5">
								<Label htmlFor="scanlines-direction" className="text-[11px] flex items-center gap-1.5">
									<GanttChartSquare className={cn('h-3 w-3', effectColors.scanlines.text)} />
									Dirección
								</Label>
								<Select
				...
				<TabsContent value="glow" className="space-y-3 mt-2">
					<div className={cn('border rounded-md p-2.5 space-y-2.5', effectColors.glow.border, effectColors.glow.bg)}>
						<div className="grid grid-cols-2 gap-2">
							<div className="space-y-1.5">
								<div className="flex items-center justify-between">
									...
									<span className="text-[10px] font-mono text-muted-foreground">{localGlowOptions.size || '10'}px</span>
								</div>
								<Slider
									id="glow-size"
						...
						<div className="grid grid-cols-2 gap-2">
							<div className="space-y-1.5">
								<Label htmlFor="glow-color" className="text-[11px] flex items-center gap-1.5">
									<FlameKindling className={cn('h-3 w-3', effectColors.glow.text)} />
									Color
								</Label>
							...
							<div className="space-y-1.5">
								<div className="flex items-center justify-between">
									...
									<Switch
										...
										onCheckedChange={(checked) => updateGlowOption('animationType', checked ? 'pulse' : 'static')}
									/>
								</div>
								{localGlowOptions.animationType === 'pulse' && (
									<div className="flex items-center gap-2">
										<Label htmlFor="glow-animation-speed" className="text-[11px] whitespace-nowrap">
											Velocidad
										</Label>
										<Slider
										...
										/>
										<span className="text-[10px] font-mono text-muted-foreground w-6 text-center">1.0</span>
									</div>
								)}
							</div>
						</div>
				...
				<TabsContent value="border" className="space-y-3 mt-2">
					<div
						className={cn('border rounded-md p-2.5 space-y-2.5', effectColors.border.border, effectColors.border.bg)}
					>
						<div className="grid grid-cols-2 gap-2">
							<div className="space-y-1.5">
								<div className="flex items-center justify-between">
							...
							<div className="space-y-1.5">
								<Label htmlFor="border-pattern" className="text-[11px] flex items-center gap-1.5">
						...
						<div className="grid grid-cols-2 gap-2">
							...
							<div className="space-y-1.5">
								...
								<Select
									...
									onValueChange={(value) =>
										updateBorderOption('animationType', value as BorderOptions['animationType'])
									}
								>
									<SelectTrigger className="h-7 text-xs">
				...
				<TabsContent value="grain" className="space-y-3 mt-2">
					<div className={cn('border rounded-md p-2.5 space-y-2.5', effectColors.grain.border, effectColors.grain.bg)}>
						<div className="grid grid-cols-2 gap-2">
							<div className="space-y-1.5">
								<div className="flex items-center justify-between">
						...
						<div className="grid grid-cols-2 gap-2">
							<div className="space-y-1.5">
								<Label htmlFor="grain-noise" className="text-[11px] flex items-center gap-1.5">
									<GrainIcon className={cn('h-3 w-3', effectColors.grain.text)} />
									Tipo de Ruido
								</Label>
								<Select
							...
							<div className="space-y-1.5">
								...
								{localGrainOptions.animated && (
									<div className="flex items-center gap-2">
										<Label htmlFor="grain-anime-speed" className="text-[11px] whitespace-nowrap">
											Velocidad
										</Label>
										<Slider
											...
											max={3}
											step={0.1}
											onValueChange={(value) => updateGrainOption('animationSpeed', value[0])}
										/>
