...
import { Box, Info, LayoutGrid, PaintBucket, Palette, Ruler, Square } from 'lucide-react';
			...
			<CardContent className="p-2.5 space-y-3">
					...
					<div className="grid grid-cols-2 gap-2">
						...
						<div className="space-y-1.5">
							<div className="flex items-center justify-between">
								<Label htmlFor="cornerRadius" className="text-[11px] flex items-center gap-1.5">
				...
				<div className="space-y-3">
					...
					<div className="grid grid-cols-2 gap-2">
						...
						<div className="space-y-1.5">
							<div className="flex items-center justify-between">
								<Label htmlFor="imageOverlay" className="text-[11px] flex items-center gap-1.5 cursor-pointer">
									Superposición
									<TooltipProvider>
										<Tooltip>
							...
							{cardOptions.imageOverlay && (
								<div className="pt-1.5">
									<div className="flex items-center justify-between">
										<Label htmlFor="imageOverlayOpacity" className="text-[11px]">
											Opacidad
										</Label>
										<span className="text-[10px] font-mono text-muted-foreground">
