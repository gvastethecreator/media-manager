...
export function PresetsPanel({
	...
	return (
		<Card
			className={cn("border border-border/40 shadow-sm", presetsColors.border)}
		>
					...
					<TooltipProvider>
						<Tooltip>
							...
							<TooltipContent side="top" className="text-[10px] max-w-[180px]">
								Selecciona un diseño predefinido para tu tarjeta con diferentes
	...
	return (
		...
		>
			...
			<div className="absolute bottom-1 right-1 flex gap-0.5">
				...
				{(preset.options.enableLightHalo ||
					preset.options.enableAnimatedBorder) && (
