...
export function StatesSettings({
	...
	return (
		<Card
			className={cn("border border-border/40 shadow-sm", statesColors.border)}
		>
							...
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleStateChange("enableHover", checked)
									}
								/>
							</div>
						</div>
						...
						<div className="space-y-1.5">
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleStateChange("enableFocus", checked)
									}
								/>
							</div>
						</div>
						...
						<div className="space-y-1.5">
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleStateChange("enableActive", checked)
									}
								/>
							</div>
						</div>
						...
						<div className="space-y-1.5">
							<div className="flex items-center justify-between">
								...
								<Switch
									...
									onCheckedChange={(checked) =>
										handleStateChange("enableSelected", checked)
									}
								/>
							</div>
						</div>
					...
					<div className="mt-2 space-y-2">
						...
						<div className="space-y-1.5">
							...
							<Select
								...
								onValueChange={(value) =>
									handleStateChange("stateEffect", value)
								}
							>
						...
						<div className="grid grid-cols-2 gap-2">
							<div className="space-y-1.5">
								...
								<Slider
									...
									onValueChange={(value) =>
										handleStateChange("stateIntensity", value[0])
									}
							...
							<div className="space-y-1.5">
								...
								<Slider
									...
									onValueChange={(value) =>
										handleStateChange("stateDuration", value[0])
									}
									className="cursor-pointer"
								/>
							</div>
