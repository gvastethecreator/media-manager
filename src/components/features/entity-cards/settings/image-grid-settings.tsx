...
export function ImageGridSettings({
	cardOptions,
	onCardOptionsChange,
}: CardSettingsProps) {
				...
				<div className="space-y-3">
					<div className="grid grid-cols-2 gap-2">
						<div className="space-y-1.5">
							...
							<Select
								...
								onValueChange={(value) =>
									handleOptionChange("imageGridLayout", value)
								}
							>
						...
						<div className="space-y-1.5">
							...
							<Select
								value={imageGridStyle}
								onValueChange={(value) =>
									handleOptionChange("imageGridStyle", value)
								}
							>
					...
					<div className="space-y-1.5">
						...
						<Slider
							...
							value={[imageGridGap]}
							onValueChange={([value]) =>
								handleOptionChange("imageGridGap", value)
							}
						/>
					</div>
						...
						<div className="flex items-center justify-between">
							...
							<Switch
								...
								onCheckedChange={(checked) =>
									handleOptionChange("showImageCount", checked)
								}
							/>
						</div>
					</div>
