...
export function DesignPanel({
  ...
  const handlePropertyChange = <K extends keyof DesignSystem>(
    property: K,
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Elige un estilo predefinido para la tarjeta
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Controla la proporción de ancho y alto
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="corner-rounded" className="cursor-pointer">Redondeadas</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="sharp" id="corner-sharp" />
                    <Label htmlFor="corner-sharp" className="cursor-pointer">Rectas</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="custom" id="corner-custom" />
                    <Label htmlFor="corner-custom" className="cursor-pointer">Personalizado</Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-muted-foreground mt-1">
                  Controla la altura percibida de la tarjeta
                </p>
              </div>
