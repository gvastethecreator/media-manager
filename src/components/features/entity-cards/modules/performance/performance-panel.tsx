    ...
    >
      ...
      >
        <TabsList className="grid w-full grid-cols-4 h-8">
          <TabsTrigger className="text-[10px]" value="general">General</TabsTrigger>
          <TabsTrigger className="text-[10px]" value="images">Imágenes</TabsTrigger>
          <TabsTrigger className="text-[10px]" value="animations">Animaciones</TabsTrigger>
