...
export function useLayerAnimation(enabled: boolean, type: 'follow-mouse' | 'pulse' | 'static', speed = 1) {
...
export function useLayerTransform(isExploded: boolean, layerIndex: number, spacing = 10) {
	return React.useMemo(() => {
