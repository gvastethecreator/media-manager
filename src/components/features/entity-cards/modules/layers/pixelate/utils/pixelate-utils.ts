...
function applyEdgeDetection(data: Uint8ClampedArray, width: number, height: number, config: PixelateConfig): void {
...
function applyGlitch(data: Uint8ClampedArray, width: number, height: number, config: PixelateConfig): void {
