...
import { imageConfigSchema, type ImageConfig } from '../image-config.action';
 ...
 */
export async function updateImageConfig(entityType: string, entityId: string, config: Partial<ImageConfig>) {
	try {
