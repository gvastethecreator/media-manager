 ...
 */
function applyColorChannels(imageData: ImageData, config: GlitchConfig, random: SeededRandom): void {
 ...
 */
export function generateGlitch(imageData: ImageData, config: GlitchConfig, time = 0): ImageData {
	const { width, height } = imageData;
