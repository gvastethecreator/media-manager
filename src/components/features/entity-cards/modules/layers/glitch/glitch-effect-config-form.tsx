...
export function GlitchEffectConfigForm({ entityType, entityId, defaultValues }: GlitchEffectConfigFormProps) {
	...
	return (
		<Card className="w-full">
			<CardHeader>
				...
				<CardDescription>Personaliza el efecto de distorsión tipo glitch para tus tarjetas</CardDescription>
			</CardHeader>
			<CardContent>
				<Form {...form}>
									...
									render={({ field }) => (
										<FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
											<div className="space-y-0.5">
												...
												<FormDescription>Habilita o deshabilita este efecto para la entidad</FormDescription>
											</div>
											<FormControl>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormDescription>Selecciona el estilo de la distorsión glitch</FormDescription>
											<FormMessage />
										</FormItem>
									)}
								/>
										...
										render={({ field }) => (
											<FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
												<div className="space-y-0.5">
													...
													<FormDescription>Efecto de separación de canales de color</FormDescription>
												</div>
												<FormControl>
													<Switch
														checked={field.value}
										...
										render={({ field }) => (
											<FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
												<div className="space-y-0.5">
													...
													<FormDescription>Añade líneas horizontales como en pantallas antiguas</FormDescription>
												</div>
												<FormControl>
													<Switch
														checked={field.value}
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormDescription>Controla cómo se fusiona el efecto con la imagen base</FormDescription>
											<FormMessage />
										</FormItem>
									)}
								/>
										...
										render={({ field }) => (
											<FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
												<div className="space-y-0.5">
													...
													<FormDescription>El efecto se activa cuando el cursor pasa sobre la tarjeta</FormDescription>
												</div>
												<FormControl>
													<Switch
														checked={field.value}
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<FormDescription>0 para mantener el efecto activo indefinidamente</FormDescription>
												<FormMessage />
											</FormItem>
										)}
									/>
			...
			<CardFooter className="border-t text-sm text-muted-foreground">
				<p>
					Ajusta los parámetros para personalizar el efecto de distorsión digital tipo glitch para la visualización de
					tus tarjetas.
				</p>
			</CardFooter>
		</Card>
