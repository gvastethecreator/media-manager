		...
		>
			{texture && (
				<>
					...
					<TextureList selectedTexture={texture} onSelect={handleTextureChange} />
					<TextureAdvancedOptions texture={texture} onChange={handleTextureChange} />
					<PatternSelector
						selectedPattern={texture.patternType}
						onSelect={(pattern) => handleTextureChange({ ...texture, patternType: pattern })}
					/>
				</>
			)}
		</div>
