...
import {
	type AnimatedBorderConfig,
	getAnimatedBorderConfig,
	updateAnimatedBorderConfig,
} from '@/components/features/entity-cards/layers/animated-border/actions';
	...
	return (
		<Card className={cn('w-full', className)}>
			<CardHeader>
				...
				<CardDescription>Personaliza el aspecto y comportamiento del borde animado para esta entidad.</CardDescription>
			</CardHeader>
			<CardContent>
				<Form {...form}>
					<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
						...
						{form.watch('enabled') && (
							<div className="mb-6">
								...
								<div className="w-full h-20 border-box transition-all duration-300" style={previewStyle} />
							</div>
						)}
							...
							render={({ field }) => (
								<FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
									<div className="space-y-0.5">
										...
										<FormDescription>Activa o desactiva el efecto de borde animado.</FormDescription>
									</div>
									<FormControl>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormDescription>El tipo de animación que se aplicará al borde.</FormDescription>
										</FormItem>
									)}
								/>
										...
										<FormItem>
											...
											<FormControl>
												<div className="flex gap-2">
													<Input {...field} type="text" placeholder="#ffffff" />
													<input
														type="color"
														value={field.value}
											...
											<FormDescription>Color principal del borde animado.</FormDescription>
										</FormItem>
									)}
								/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormControl>
												<div className="flex gap-2">
													<Input {...field} type="text" placeholder="#00ffff" />
													<input
														type="color"
														value={field.value}
														onChange={(e) => field.onChange(e.target.value)}
											...
											<FormDescription>Color secundario para efectos de transición.</FormDescription>
										</FormItem>
									)}
								/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormDescription>Grosor del borde animado en píxeles.</FormDescription>
										</FormItem>
									)}
								/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormDescription>Intensidad del efecto de brillo alrededor del borde.</FormDescription>
										</FormItem>
									)}
								/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormControl>
												<Input {...field} type="text" placeholder="rgba(255, 255, 255, 0.5)" />
											</FormControl>
											<FormDescription>Color del efecto de brillo (formato rgba recomendado).</FormDescription>
										</FormItem>
									)}
								/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormDescription>Transparencia del borde animado.</FormDescription>
										</FormItem>
									)}
								/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormDescription>Redondeo de las esquinas del borde.</FormDescription>
										</FormItem>
									)}
								/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormControl>
												<Input {...field} value={field.value || ''} type="text" placeholder="5,5" />
											</FormControl>
											<FormDescription>Patrón de segmentos del borde (formato: "largo,espacio").</FormDescription>
										</FormItem>
									)}
								/>
							</>
