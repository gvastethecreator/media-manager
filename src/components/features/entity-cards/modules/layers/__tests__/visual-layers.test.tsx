...
describe('Visual Layers', () => {
	...
	describe('Multiple Visual Layers', () => {
		it('should render multiple layers in correct order', () => {
			render(
				<EntityCardProvider>
					<RegisterLayers initialLayers={[GradientLayer, BlurLayer, GlowLayer]} />
					<EntityCard
						entityId="test"
						entityType="test"
						layers={{
	...
	describe('Conditional Styles', () => {
		const ConditionalLayer = {
			...
			Component: ({ enabled, config }) => {
				...
				return enabled ? <div data-testid="conditional-layer" style={style} /> : null;
			},
		};
	...
	describe('Layer Composition', () => {
		const CompositeLayer = {
			...
			Component: ({ enabled, config }) => {
				...
				return enabled ? <div data-testid="composite-layer" style={{ filter: filters }} /> : null;
			},
		};
