...
export function useGrid({ config, shouldRender }: UseGridProps): UseGridReturn {
	...
	const renderLines = (ctx: CanvasRenderingContext2D, width: number, height: number, config: GridConfig) => {
	...
	const renderDots = (ctx: CanvasRenderingContext2D, width: number, height: number, config: GridConfig) => {
	...
	const renderSquares = (ctx: CanvasRenderingContext2D, width: number, height: number, config: GridConfig) => {
		const { spacing, thickness, showSubgrid, subgridDivisions, subgridOpacity } = config;
	...
	const renderDiamonds = (ctx: CanvasRenderingContext2D, width: number, height: number, config: GridConfig) => {
		const { spacing, showSubgrid, subgridDivisions, subgridOpacity } = config;
	...
	const renderHexagons = (ctx: CanvasRenderingContext2D, width: number, height: number, config: GridConfig) => {
