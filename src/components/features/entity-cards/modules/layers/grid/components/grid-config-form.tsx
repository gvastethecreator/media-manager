...
import { BLEND_MODES, GRID_COLORS, GRID_PRESETS, GRID_TYPES, type GridConfig } from '../grid-config-types';
							...
							<FormItem className={form.watch('colorMode') !== 'custom' ? 'opacity-50' : ''}>
								...
								<FormControl>
									<div className="flex gap-2">
										...
										<Input type="text" {...field} disabled={form.watch('colorMode') !== 'custom'} />
									</div>
								</FormControl>
							</FormItem>
						)}
