          ...
          <TabsContent value="advanced" className="space-y-4">
            <div className="space-y-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Entidad a la que se aplica esta configuración
                </p>
              </div>
                      ...
                      {availableLayers.map((layer) => {
                        ...
                        return (
                          <TableRow key={layer.type}>
                            <TableCell>
                              <div className={layerConfig.enabled ? "bg-green-500/20 text-green-500 rounded-full px-2 py-0.5 text-[10px] font-medium text-center" : "bg-red-500/10 text-red-400 rounded-full px-2 py-0.5 text-[10px] font-medium text-center"}>
