...
export function ExplodePanel({
	...
	const getCurrentPreset = () => {
		...
		const exactMatch = explodePresets.find((p) => JSON.stringify(p.explodeSystem) === JSON.stringify(explodeSystem));
						...
						<div className="space-y-4">
							...
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-xs text-muted-foreground mt-1">Activa o desactiva la vista explosionada</p>
								</div>
								<Switch
									id="explode-enabled"
							...
							{explodeSystem.enabled && (
								<>
									<div className="space-y-2">
										...
										<p className="text-xs text-muted-foreground mt-1">Eje en el que se separarán las capas</p>
									</div>
									...
									<div className="space-y-2">
										...
										<Slider
											...
											disabled={disabled}
										/>
										<p className="text-xs text-muted-foreground mt-1">Intensidad del efecto de perspectiva 3D</p>
									</div>
									...
									{layersList.length > 0 && (
										<div className="space-y-2">
											...
											<p className="text-xs text-muted-foreground mt-1">Capa que se mantendrá fija en el centro</p>
										</div>
									)}
									...
									<div className="flex items-center justify-between">
										<div>
											...
											<p className="text-xs text-muted-foreground mt-1">Muestra el nombre de cada capa</p>
										</div>
										<Switch
											id="show-labels"
					...
					<TabsContent value="rotation" className="space-y-4">
						<div className="space-y-4">
							<div className="space-y-2">
								...
								/>
								<p className="text-xs text-muted-foreground mt-1">Rotación en el eje horizontal</p>
							</div>
							...
							<div className="space-y-2">
								...
								<Slider
									...
									disabled={disabled || !explodeSystem.enabled}
								/>
								<p className="text-xs text-muted-foreground mt-1">Rotación en el eje vertical</p>
							</div>
							...
							<div className="space-y-2">
								...
								<Slider
									...
									disabled={disabled || !explodeSystem.enabled}
								/>
								<p className="text-xs text-muted-foreground mt-1">Rotación en el eje de profundidad</p>
							</div>

							<div className="flex items-center justify-between">
								<div>
									<Label htmlFor="auto-rotate">Rotación Automática</Label>
									<p className="text-xs text-muted-foreground mt-1">Rota la vista automáticamente</p>
								</div>
								<Switch
									id="auto-rotate"
							...
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-xs text-muted-foreground mt-1">Amplía la separación al pasar el ratón</p>
								</div>
								<Switch
									id="expand-hover"
						...
						<div className="space-y-4">
							<div className="flex items-center justify-between">
								<div>
									...
									<p className="text-xs text-muted-foreground mt-1">Anima la transición a vista explosionada</p>
								</div>
								<Switch
									id="animated"
								...
								<>
									<div className="space-y-2">
										...
										<Slider
											...
											disabled={disabled || !explodeSystem.enabled}
										/>
										<p className="text-xs text-muted-foreground mt-1">Duración de la transición a vista explosionada</p>
									</div>

									<div className="flex items-center justify-between">
										<div>
											<Label htmlFor="staggered">Efecto Escalonado</Label>
											<p className="text-xs text-muted-foreground mt-1">Anima las capas con efecto cascada</p>
										</div>
										<Switch
											id="staggered"
									...
									{explodeSystem.staggered && (
										<div className="space-y-2">
											...
											<Slider
												...
												disabled={disabled || !explodeSystem.enabled || !explodeSystem.animated}
											/>
											<p className="text-xs text-muted-foreground mt-1">Tiempo entre la animación de cada capa</p>
										</div>
									)}
								</>
							)}
