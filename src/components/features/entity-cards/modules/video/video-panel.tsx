		...
		>
			<Tabs defaultValue="design" value={activeTab} onValueChange={setActiveTab} className="w-full">
				<TabsList className="grid w-full grid-cols-4 h-8">
					<TabsTrigger className="text-[10px]" value="design">
						Diseño
					</TabsTrigger>
					<TabsTrigger className="text-[10px]" value="effects">
						Efectos
					</TabsTrigger>
					<TabsTrigger className="text-[10px]" value="controls">
						Controles
					</TabsTrigger>
				...
				<TabsContent value="effects" className="mt-4 space-y-6">
					<BasicEffectsSection videoOptions={videoOptions} handleVideoChange={handleVideoChange} disabled={disabled} />
					<DepthEffectsSection
						videoOptions={videoOptions}
