...
export function InteractionModule({ initialOptions, onChange, disabled, className }: InteractionModuleProps) {
		...
		>
			...
			{options.enabled && (
				<div className="mt-4 space-y-6">
					<Tabs defaultValue="mouse" value={activeTab} onValueChange={setActiveTab} className="w-full">
						<TabsList className="grid w-full grid-cols-3 h-8">
							<TabsTrigger className="text-[10px]" value="mouse">
								Mouse
							</TabsTrigger>
							<TabsTrigger className="text-[10px]" value="touch">
								Táctil
							</TabsTrigger>
