...
export function StatesPanel({
  ...
  const handleStatePropertyChange = (
    stateName: keyof StatesSystem,
    propertyName: string,
    value: unknown
  ) => {
    onChange({
  ...
  const handleRotateOrLiftChange = (
    stateName: keyof StatesSystem,
    propertyName: 'rotate' | 'lift',
    value: number
  ) => {
              ...
              <FormSection title="Efectos visuales">
                <FormGroup>
                  ...
                  <FormSlider
                    ...
                    onValueChange={(value) =>
                      handleRotateOrLiftChange('hover', 'rotate', value)
                    }
                    min={-5}
                    max={5}
                    step={0.5}
                  ...
                  <FormSlider
                    ...
                    onValueChange={(value) =>
                      handleRotateOrLiftChange('hover', 'lift', value)
                    }
                    min={-20}
                    max={20}
                    unit="px"
              ...
              <FormSection title="Efectos visuales">
                <FormGroup>
                  ...
                  <FormSlider
                    ...
                    onValueChange={(value) =>
                      handleRotateOrLiftChange('focus', 'rotate', value)
                    }
                    min={-5}
                    max={5}
                    step={0.5}
                  ...
                  <FormSlider
                    ...
                    onValueChange={(value) =>
                      handleRotateOrLiftChange('focus', 'lift', value)
                    }
                    min={-20}
                    max={20}
                    unit="px"
              ...
              <FormSection title="Efectos visuales">
                <FormGroup>
                  ...
                  <FormSlider
                    ...
                    onValueChange={(value) =>
                      handleRotateOrLiftChange('selected', 'rotate', value)
                    }
                    min={-5}
                    max={5}
                    step={0.5}
                  ...
                  <FormSlider
                    ...
                    onValueChange={(value) =>
                      handleRotateOrLiftChange('selected', 'lift', value)
                    }
                    min={-20}
                    max={20}
                    unit="px"
