...
import { FormLayout, FormSection, panelColors } from '@/components/features/entity-cards/settings/panels/shared';
...
export function AdvancedEffectsPanel({
	...
	const { effects, updateEffect, updateEffects } = useAdvancedEffects(options.advancedEffects);
	...
	const handleEffectsChange = <K extends keyof AdvancedEffectsOptions>(key: K, value: AdvancedEffectsOptions[K]) => {
		...
		<FormLayout>
			...
			>
				<div className="space-y-6">
					...
					<ScanEffectsSection effects={effects} onEffectsChange={handleEffectsChange} disabled={disabled} />

					<TextureEffectsSection effects={effects} onEffectsChange={handleEffectsChange} disabled={disabled} />

					<BorderEffectsSection effects={effects} onEffectsChange={handleEffectsChange} disabled={disabled} />

					<HolographicEffectsSection effects={effects} onEffectsChange={handleEffectsChange} disabled={disabled} />

					<DistortionEffectsSection effects={effects} onEffectsChange={handleEffectsChange} disabled={disabled} />
				</div>
			</FormSection>
		</FormLayout>
	);
