...
import {
  Paintbrush, Rainbow, ScanLine, Wallpaper, Zap
} from 'lucide-react';
import {
  FormColorPicker,
  FormGroup,
 ...
 */
export const ScanEffectsSection = ({
  effects,
  onEffectsChange,
  disabled
}: SectionProps) => {
 ...
 */
export const TextureEffectsSection = ({
  effects,
  onEffectsChange,
  disabled
}: SectionProps) => {
 ...
 */
export const BorderEffectsSection = ({
  effects,
  onEffectsChange,
  disabled
}: SectionProps) => {
 ...
 */
export const HolographicEffectsSection = ({
  effects,
  onEffectsChange,
  disabled
}: SectionProps) => {
 ...
 */
export const DistortionEffectsSection = ({
  effects,
  onEffectsChange,
  disabled
}: SectionProps) => {
