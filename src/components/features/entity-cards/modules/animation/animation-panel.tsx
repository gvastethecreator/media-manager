...
import { PlayCircle, MousePointer, Zap, Clock } from 'lucide-react';
...
export function AnimationPanel({
  ...
  const getCurrentPreset = () => {
    ...
    if (!animationSystem.enabled) return 'none';
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Selecciona un estilo predefinido de animaciones
                </p>
              </div>
                ...
                <>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Repetir animaciones continuamente
                      </p>
                    </div>
                    <Switch
                      id="loop-animations"
              ...
              {animationSystem.enabled && animationSystem.hoverEffect && (
                <>
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-muted-foreground mt-1">
                      Factor de escala aplicado al pasar el ratón
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Rota la tarjeta según la posición del cursor
                      </p>
                    </div>
                    <Switch
                      id="hover-rotate"
          ...
          <TabsContent value="timing" className="space-y-4">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-muted-foreground mt-1">
                  Duración de todas las animaciones en milisegundos
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Controla la aceleración de las animaciones
                </p>
              </div>
              ...
              {animationSystem.timingFunction === 'custom' && (
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-muted-foreground mt-1">
                    Especifica una función cubic-bezier o steps()
                  </p>
                </div>
              )}
            </div>
