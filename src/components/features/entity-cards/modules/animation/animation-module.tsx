...
import type { AnimationModuleProps, AnimationSystem } from './types';
 ...
 */
export function AnimationModule({ initialAnimationSystem, onChange, disabled, className }: AnimationModuleProps) {
