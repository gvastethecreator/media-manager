...
export function ImagePanel({
  ...
  const {
    ...
    updateEffect,
    updatePerformance
  } = useImageSettings(options.imageOptions);
  ...
  const handleEffectsChange = (section: string, key: string, value: unknown) => {
    ...
    if (!newOptions.imageOptions) {
      newOptions.imageOptions = { enable3DEffect: false, enableHolographicEffect: false, enableGlowEffect: false, enableAnimatedBorder: false, enableLightHalo: false };
    }
