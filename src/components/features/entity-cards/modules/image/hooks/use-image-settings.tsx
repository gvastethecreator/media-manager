...
export function useImageSettings(initialOptions?: Partial<ImageOptions>) {
	 ...
	 */
	const updateImageOption = useCallback(<K extends keyof ImageOptions>(key: K, value: ImageOptions[K]) => {
	 ...
	 */
	const updateDesignSystem = useCallback((key: string, value: unknown) => {
		setImageOptions((prev) => {
	 ...
	 */
	const updateEffect = useCallback((section: string, key: string, value: unknown) => {
		setImageOptions((prev) => {
			const newOptions = { ...prev };
	 ...
	 */
	const updatePerformance = useCallback((key: string, value: unknown) => {
		setImageOptions((prev) => {
			const newOptions = { ...prev };
