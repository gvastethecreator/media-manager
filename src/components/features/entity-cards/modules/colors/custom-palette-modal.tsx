		...
		<Dialog open={true} onOpenChange={(open) => !open && onClose()}>
			<DialogContent className="sm:max-w-[500px]">
				<DialogHeader>
					...
					<DialogDescription>
						Define los colores para tu paleta personalizada. Todos los colores deben estar en formato RGB (ej: 59, 130,
						246).
					</DialogDescription>
				</DialogHeader>
				...
				<div className="grid gap-4 py-4">
					...
					<div className="grid grid-cols-2 gap-4">
						...
						<FormInput
							...
							icon={
								<div className="h-4 w-4 rounded-full border" style={{ backgroundColor: `rgb(${palette.textColor})` }} />
							}
						/>
					</div>
					...
					<FormInput
						...
						icon={
							<div className="h-4 w-4 rounded-full border" style={{ backgroundColor: `rgb(${palette.borderColor})` }} />
						}
					/>
				</div>
