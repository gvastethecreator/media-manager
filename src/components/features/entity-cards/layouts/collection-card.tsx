...
import { CollectionCard as CollectionCardLayout, type CollectionCardProps } from './collection-card-layout';
 ...
 */
export const CollectionCard = createCustomCardAdapter<Collection, CollectionCardProps, 'collection'>(
