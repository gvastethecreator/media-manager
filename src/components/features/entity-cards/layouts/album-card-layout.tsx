...
export function AlbumCard({
	...
	useEffect(() => {
		...
		const hasChanged =
			(hasProperty(prevData, "name") &&
				hasProperty(data, "name") &&
				prevData.name !== data.name) ||
			(hasProperty(prevData, "emoji") &&
				hasProperty(data, "emoji") &&
				prevData.emoji !== data.emoji) ||
			(hasProperty(prevData, "color") &&
				hasProperty(data, "color") &&
				...
				<div className="z-10 flex flex-1 flex-col">
					<div className="flex items-center space-x-2">
						...
						<h3 className="text-xl font-semibold line-clamp-1">
							{getStringProp(data, "name", "Sin nombre")}
						</h3>
					</div>
	...
	return (
		...
		>
			<div
				className="relative h-full p-4 flex flex-col z-10"
				onMouseMove={handleMouseMove}
			>
				{/* Encabezado */}
