...
import { deleteNoiseTextureConfig, getNoiseTextureConfig, updateNoiseTextureConfig } from './actions/noise-texture-config.action';
...
export { getNoiseTextureConfig, updateNoiseTextureConfig, deleteNoiseTextureConfig } from './actions/noise-texture-config.action';
