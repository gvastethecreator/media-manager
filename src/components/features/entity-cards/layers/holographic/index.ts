...
import { deleteHolographicConfig, getHolographicConfig, updateHolographicConfig } from './actions/holographic-config.action';
...
export { getHolographicConfig, updateHolographicConfig, deleteHolographicConfig } from './actions/holographic-config.action';
