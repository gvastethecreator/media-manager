						...
						<div className="flex items-center justify-between">
							<Label htmlFor="visibleOnHover" className="flex flex-col space-y-1">
								...
								<span className="text-xs text-muted-foreground">
									Los filtros solo se muestran al pasar el mouse
								</span>
							</Label>
							<Switch
								id="visibleOnHover"
					...
					<TabsContent value="presets" className="space-y-4">
						<div className="space-y-4">
							...
							<p className="text-sm text-muted-foreground">
								Estos presets proporcionan configuraciones optimizadas para diferentes efectos visuales.
								Puedes seleccionar uno y luego ajustar la configuración según tus necesidades.
							</p>
						</div>
						...
						{localConfig.glow?.enabled && (
							<>
								...
								<div className="space-y-2">
									...
									/>
									<span className="text-xs text-muted-foreground">
										Controla el tamaño del área de resplandor
									</span>
								</div>
						...
						{localConfig.distortion?.enabled && (
							<>
								...
								<div className="space-y-2">
									...
									/>
									<span className="text-xs text-muted-foreground">
										Controla la densidad de las ondulaciones
									</span>
								</div>
							</>
						)}
