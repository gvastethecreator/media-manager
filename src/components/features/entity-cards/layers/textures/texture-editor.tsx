	...
	return (
		<div className="space-y-4">
			<div className="space-y-2">
				<Label>Patrón</Label>
				<Select value={texture.patternType} onValueChange={(value) => handleChange('patternType', value)}>
					<SelectTrigger>
			...
			<div className="space-y-2">
				<Label>Color</Label>
				<ColorPicker color={texture.color} onChange={(color) => handleChange('color', color)} />
			</div>
			...
			<div className="space-y-2">
				...
				<Input
					...
					onChange={(e) => handleChange('layerOrder', Number.parseInt(e.target.value))}
					min={0}
					max={10}
				/>
			</div>
