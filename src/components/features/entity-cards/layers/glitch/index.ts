...
import { type GlitchEffectConfig, deleteGlitchEffectConfig, getGlitchEffectConfig, updateGlitchEffectConfig } from './actions/glitch-effect-config.action';
...
export { getGlitchEffectConfig, updateGlitchEffectConfig, deleteGlitchEffectConfig } from './actions/glitch-effect-config.action';
