...
export async function getBorderConfig(entityType: string, entityId?: string): Promise<BorderConfigResponse> {
	try {
...
export async function deleteBorderConfig(entityType: string, entityId?: string): Promise<BorderConfigResponse> {
	try {
		const validation = borderConfigSchema.safeParse({
			entityType,
			entityId,
