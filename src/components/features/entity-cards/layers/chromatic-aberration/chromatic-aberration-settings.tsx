...
import { type ChromaticAberrationConfig, getChromaticAberrationConfig, updateChromaticAberrationConfig } from '@/components/features/entity-cards/layers/chromatic-aberration/actions';
  ...
  return (
    <Card className={cn('w-full', className)}>
      <CardHeader>
        ...
        <CardDescription>
          Personaliza el efecto de aberración cromática para tus entidades.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Activa o desactiva el efecto de aberración cromática.
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Intensidad del efecto de aberración cromática.
                      </FormDescription>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Controla el desplazamiento general de los colores.
                      </FormDescription>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Controla el desplazamiento del canal rojo.
                      </FormDescription>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Controla el desplazamiento del canal verde.
                      </FormDescription>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Controla el desplazamiento del canal azul.
                      </FormDescription>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Dirección del efecto de aberración cromática.
                      </FormDescription>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Modo de mezcla para el efecto de aberración cromática.
                      </FormDescription>
                    </FormItem>
                  )}
                />
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                      <div className="space-y-0.5">
                        ...
                        <FormDescription>
                          El efecto se animará al pasar el ratón sobre la entidad.
                        </FormDescription>
                      </div>
                      <FormControl>
                        <Switch
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Tipo de animación para el efecto.
                          </FormDescription>
                        </FormItem>
                      )}
                    />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Controla la cantidad de desenfoque del efecto.
                      </FormDescription>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Calidad del renderizado (impacta en el rendimiento).
                      </FormDescription>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Modelo de color para el efecto de aberración.
                      </FormDescription>
                    </FormItem>
                  )}
                />
