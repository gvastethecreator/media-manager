							...
							render={({ field }) => (
								<FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
									<div className="space-y-0.5">
										...
										<FormDescription>
											Activa o desactiva el efecto de brillo en las tarjetas.
										</FormDescription>
									</div>
									<FormControl>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormDescription>
												Selecciona el color del efecto glow.
											</FormDescription>
										</FormItem>
									)}
								/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormDescription>
												Controla la intensidad del efecto glow.
											</FormDescription>
										</FormItem>
									)}
								/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormDescription>
												Controla el tamaño del efecto glow en píxeles.
											</FormDescription>
										</FormItem>
									)}
								/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormDescription>
												Controla el nivel de desenfoque del efecto glow.
											</FormDescription>
										</FormItem>
									)}
								/>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											...
											<FormDescription>
												Selecciona el tipo de animación para el efecto glow.
											</FormDescription>
										</FormItem>
									)}
								/>
