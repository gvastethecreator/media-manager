					...
					<TabsContent value="basic" className="space-y-4">
						...
						<div className="space-y-2">
							...
							<Select
								...
								onValueChange={(value) =>
									handleChange({ patternType: value as PatternConfig['patternType'] })
								}
							>
								<SelectTrigger>
					...
					<TabsContent value="appearance" className="space-y-4">
						...
						<div className="space-y-2">
							...
							<Select
								...
								onValueChange={(value) =>
									handleChange({ blendMode: value as PatternConfig['blendMode'] })
								}
							>
								<SelectTrigger>
						...
						<div className="space-y-2">
							...
							/>
							<span className="text-xs text-muted-foreground">
								Controla cuántos elementos del patrón se muestran
							</span>
						</div>
