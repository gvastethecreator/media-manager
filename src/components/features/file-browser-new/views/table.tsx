...
import { ArrowUpDown, ArrowUp, ArrowDown, Folder, CornerUpLeft } from 'lucide-react';
...
export function TableView({
    ...
    const columns = DEFAULT_COLUMNS.filter(
        (col) => !config.visibleColumns || config.visibleColumns.includes(col.key)
    );
