...
import { CardsViewV2 } from './views/cards-view-v2';
import { ListViewV2 } from './views/list-view-v2';
import { MasonryViewV2 } from './views/masonry-view-v2';
import { SimpleGridViewV2 } from './views/simple-grid-view-v2';

const logger = clientLogger.withContext('FileBrowserV2');
...
export const FileBrowserV2 = memo<FileBrowserV2Props>(function FileBrowserV2({
	...
	const renderContent = () => {
		...
		switch (viewMode) {
			case 'list':
				return <ListViewV2 {...commonViewProps} />;
			case 'grid':
			case 'cards':
				return <CardsViewV2 {...commonViewProps} />;
			case 'simple-grid':
				return <SimpleGridViewV2 {...commonViewProps} />;
			case 'masonry':
				return <MasonryViewV2 {...commonViewProps} />;
			default:
				return <CardsViewV2 {...commonViewProps} />;
		}
	};
