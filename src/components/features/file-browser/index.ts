...
export { FileTable } from './components/file-table';
export { FileBrowser2 as FileBrowser } from './file-browser';

// Tipos
export type { FileBrowser2Props as FileBrowserProps } from './types/file-browser.types';
