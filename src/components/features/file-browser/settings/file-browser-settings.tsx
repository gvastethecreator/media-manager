...
import { Accessibility, Eye, Grid, List, Settings, Zap } from 'lucide-react';
...
export const FileBrowserSettings: React.FC<FileBrowserSettingsProps> = ({ onClose, className = '' }) => {
				...
				<TabsContent value="view" className="space-y-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>Configure how files and folders are displayed</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6">
							...
							<div className="flex items-center justify-between">
								<div className="space-y-0.5">
									...
									<p className="text-sm text-gray-600">Display files and folders that start with a dot</p>
								</div>
								<Switch
				...
				<TabsContent value="performance" className="space-y-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>Configure performance settings for better responsiveness</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6">
							{/* Virtualization */}
							<div className="flex items-center justify-between">
								<div className="space-y-0.5">
									...
									<p className="text-sm text-gray-600">Improves performance with large file lists</p>
								</div>
								<Switch
							...
							<div className="space-y-3">
								...
								<p className="text-sm text-gray-600">Higher values may impact performance with large directories</p>
							</div>
						</CardContent>
					</Card>
				</TabsContent>
				...
				<TabsContent value="advanced" className="space-y-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>Advanced settings and system integration</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6">
							{/* System Capabilities */}
							<div className="space-y-3">
