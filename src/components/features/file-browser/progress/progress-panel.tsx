...
import {
  Search, SortAsc, SortDesc, Play, Pause,
  RefreshCw, BarChart3, Bell, X, CheckCircle,
  XCircle, Clock, AlertCircle, Eye
} from 'lucide-react';
...
export function ProgressPanel({
  ...
  const getOperationDescription = (type: import('@/types/progress-tracking/progress-info').OperationType, totalItems: number): string => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setStatusFilter(value ? value.split(',') as ProgressStatus[] : [])
                  }
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setTypeFilter(value ? value.split(',') as OperationType[] : [])
                  }
                >
                  <SelectTrigger>
            ...
            <Tabs defaultValue="all" className="w-full">
              <TabsList className="grid w-full grid-cols-6">
                <TabsTrigger value="all">
                  Todas ({filteredOperations.length})
                </TabsTrigger>
                <TabsTrigger value="running">
                  En progreso ({operationsByStatus.running.length})
                </TabsTrigger>
                <TabsTrigger value="pending">
                  Pendientes ({operationsByStatus.pending.length})
                </TabsTrigger>
                <TabsTrigger value="completed">
                  Completadas ({operationsByStatus.completed.length})
                </TabsTrigger>
                <TabsTrigger value="failed">
                  Fallidas ({operationsByStatus.failed.length})
                </TabsTrigger>
                <TabsTrigger value="cancelled">
                  Canceladas ({operationsByStatus.cancelled.length})
                </TabsTrigger>
              </TabsList>
