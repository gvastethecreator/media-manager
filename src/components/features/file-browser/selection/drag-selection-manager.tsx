...
export const DragSelectionManager: React.FC<DragSelectionManagerProps> = ({
	...
	const { selectedItems, addToSelection, removeFromSelection, setSelection, clearSelection } = useSelectionStore();
	...
	const updateSelection = useCallback(
		(
			...
			const intersectingItems = items.filter((item) => isItemInSelection(item.id, rect));
