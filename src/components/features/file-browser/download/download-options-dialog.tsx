...
import { Archive, Download, FileText, Image, Settings, X } from 'lucide-react';
import { AnimatePresence, motion } from 'motion/react';
import React, { useState } from 'react';
import { toastService } from '@/lib/ui/toast';
import type { DownloadFormat, DownloadOptions, DownloadQuality } from '@/services/download/download.service';
...
export function DownloadOptionsDialog({ isOpen, onClose, files, onDownloadStart }: DownloadOptionsDialogProps) {
	...
	const availableFormats = formatOptions.filter((format) => format.value !== 'pdf' || hasImages);
						...
						<div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
							...
							<div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
								<div className="flex items-center gap-3">
									...
									<div>
										<h2 className="text-lg font-semibold text-gray-900 dark:text-white">Opciones de Descarga</h2>
							...
							<div className="p-6 space-y-6">
								...
								<div>
									<div className="flex items-center gap-2 mb-3">
										...
										<span className="text-sm font-medium text-gray-700 dark:text-gray-300">Opciones Avanzadas</span>
									</div>
									...
									<div className="space-y-3">
										...
										<label className="flex items-center gap-3">
											...
											/>
											<div>
												<span className="text-sm font-medium text-gray-900 dark:text-white">Mostrar progreso</span>
												<p className="text-xs text-gray-500 dark:text-gray-400">
