...
export function CollectionsSection() {
  ...
  const handleUpdateCollection = async (id: string, updates: Partial<typeof collections[0]>) => {
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-1">
                    <Input
                      ...
                      onChange={(e) =>
                        handleUpdateCollection(collection.id, { name: e.target.value })
                      }
                    />
                    <Textarea
                      ...
                      onChange={(e) =>
                        handleUpdateCollection(collection.id, { description: e.target.value })
                      }
                    />
                  </div>
