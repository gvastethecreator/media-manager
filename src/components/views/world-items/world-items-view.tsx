...
import { WorldItemCard } from '@/components/features/entity-cards/forms/world-item-card';
					...
					{optimisticWorldItems.map((worldItem, index) => (
						...
						>
							<WorldItemCard
								...
								onClick={(e) => {
									e.stopPropagation();
									handleWorldItemClick(worldItem);
								}}
								onEdit={handleEditWorldItem}
								onDelete={handleDeleteWorldItem}
							/>
						</motion.div>
					))}
				</div>
