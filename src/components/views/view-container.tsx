	...
	return (
		<div className="h-full w-full flex items-center justify-center">
			<div className="text-center p-0">
				...
				<p className="text-muted-foreground mb-4">Este componente ha sido reemplazado por React Router.</p>
				<p className="text-sm text-muted-foreground">Todas las rutas ahora se manejan en router.tsx</p>
			</div>
		</div>
	);
});
