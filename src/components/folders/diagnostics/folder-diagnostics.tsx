	...
	return (
		<Card className="w-full max-w-3xl mx-auto">
			...
			<CardContent className="pt-6">
				...
				{!results && !error && !isLoading && (
					<div className="p-6 text-center border border-dashed rounded-md">
						<p className="text-muted-foreground">Ejecute el diagnóstico para verificar el estado de la base de datos</p>
					</div>
				)}
			...
			<CardFooter className="flex justify-end">
				<Button onClick={runDiagnostics} disabled={isLoading} variant="default">
					{isLoading ? (
						<>
