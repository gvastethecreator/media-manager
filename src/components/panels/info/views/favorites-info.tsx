				...
				<div className="flex flex-col">
					...
					<p className="text-xs text-muted-foreground">
						{isLoading ? (
							...
							`${stats?.totalFavorites || 0} imágenes`
						)}
					</p>
				</div>
			</div>
				...
				<CardContent className="p-4 space-y-3">
					...
					<div className="space-y-1.5">
						<div className="flex items-center justify-between text-xs">
							...
							<span>{favoritesPercentage.toFixed(1)}%</span>
						</div>
						<Progress value={favoritesPercentage} className="h-1" />
					</div>
						...
						<div className="space-y-1">
								...
								<Progress
									value={
										stats?.totalCollections
											? (stats.totalCollections / stats.totalFavorites) * 100
											: 0
									}
									className="h-1"
								/>
							...
							<div className="space-y-1">
								...
								<Progress
									value={
										stats?.totalFolders
											? (stats.totalFolders / stats.totalFavorites) * 100
											: 0
									}
									className="h-1"
								/>
							...
							<div className="space-y-1">
								...
								<Progress
									value={
										stats?.totalAlbums
											? (stats.totalAlbums / stats.totalFavorites) * 100
											: 0
									}
									className="h-1"
								/>
