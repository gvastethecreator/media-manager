...
export function formDataToAlbum(
  data: AlbumFormData
): Omit<Album, "id" | "createdAt" | "updatedAt"> {
  return {
    name: data.name,
    emoji: data.emoji,
    color: data.color,
...
export function formDataToObject(
  data: ObjectFormData
): Omit<Object, "id" | "createdAt" | "updatedAt"> {
  return {
    name: data.name,
    emoji: data.emoji,
    color: data.color,
...
export function formDataToPlace(
  data: PlaceFormData
...
): Omit<Attribute, "id" | "createdAt" | "updatedAt"> {
  return {
    name: data.name,
    emoji: data.emoji,
    color: data.color,
...
export function formDataToConcept(
...
export function formDataToPrompt(
  data: PromptFormData
