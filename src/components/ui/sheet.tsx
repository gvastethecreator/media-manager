...
const sheetVariants = cva(
	'fixed z-50 gap-4 bg-background p-6 shadow-lg transition-transform duration-dt-normal ease-dt-out data-[state=closed]:animate-out data-[state=closed]:duration-dt-fast data-[state=closed]:ease-dt-in data-[state=open]:animate-in data-[state=open]:duration-dt-normal data-[state=open]:ease-dt-out',
	{
		variants: {
			side: {
