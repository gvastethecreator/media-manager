	...
	'inline-flex items-center rounded-dt-xs border-2 px-2.5 py-0.5 font-semibold text-xs transition-all duration-dt-fast ease-dt-out focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
	{
		variants: {
			variant: {
				...
				success:
					'border-green-500/20 bg-linear-to-b from-green-500 to-green-600 text-white shadow-dt-1 hover:shadow-dt-2',
				warning:
					'border-yellow-500/20 bg-linear-to-b from-yellow-500 to-yellow-600 text-black shadow-dt-1 hover:shadow-dt-2',
			},
		},
		defaultVariants: {
			variant: 'default',
