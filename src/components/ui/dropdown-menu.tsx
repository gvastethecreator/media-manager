...
function DropdownMenuSubTrigger({
	...
	return (
		...
		>
			{children}
			<ChevronRight className="ms-auto size-3.5! rtl:rotate-180" data-slot="dropdown-menu-sub-trigger-indicator" />
		</DropdownMenuPrimitive.SubTrigger>
	);
}
...
function DropdownMenuLabel({
	...
	return (
		<DropdownMenuPrimitive.Label
			className={cn('px-2 py-1.5 font-medium text-muted-foreground text-xs', inset && 'ps-8', className)}
