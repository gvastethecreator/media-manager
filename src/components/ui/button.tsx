...
const buttonVariants = cva(
  'btn-pulse inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-dt-sm font-medium text-sm transition-all duration-dt-normal ease-dt-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'border-2 border-primary/20 bg-gradient-to-b from-primary to-primary/90 text-primary-foreground shadow-dt-2 hover:from-primary/95 hover:to-primary/85 hover:shadow-dt-3 active:translate-y-px active:shadow-dt-1',
        primary:
          'border-2 border-primary/20 bg-gradient-to-b from-primary to-primary/90 text-primary-foreground shadow-dt-2 hover:from-primary/95 hover:to-primary/85 hover:shadow-dt-3 active:translate-y-px active:shadow-dt-1',
        destructive:
          'border-2 border-destructive/20 bg-gradient-to-b from-destructive to-destructive/90 text-destructive-foreground shadow-dt-2 hover:from-destructive/95 hover:to-destructive/85 hover:shadow-dt-3 active:translate-y-px active:shadow-dt-1',
        outline:
        ...
        secondary:
          'border-2 border-secondary/30 bg-gradient-to-b from-secondary to-secondary/90 text-secondary-foreground shadow-dt-1 hover:from-secondary/95 hover:to-secondary/80 hover:shadow-dt-2 active:translate-y-px active:shadow-dt-0',
        dim:
          'border-2 border-transparent bg-muted/40 text-muted-foreground shadow-dt-0 hover:bg-muted/60 hover:text-foreground hover:shadow-dt-1 active:translate-y-px active:bg-muted/70',
