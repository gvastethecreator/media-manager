										...
										>
											...
											>
												...
												<div className="min-w-0 flex-1">
													<h4 className="truncate font-medium text-body-sm">{character.name}</h4>
			...
			<div className="col-span-12 md:col-span-7 lg:col-span-8">
				<Card className="flex h-[calc(100vh-8rem)] flex-col rounded-dt-md border-none bg-muted/30 shadow-sm">
					<CardHeader className="px-3 py-2">
						<div className="flex items-center justify-between">
							<div>
								<CardTitle className="text-heading-sm">{isEditing ? 'Editar Personaje' : 'Nuevo Personaje'}</CardTitle>
