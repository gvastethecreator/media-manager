...
import { type PromptFormData, usePromptStore } from '@/store/prompt.store';
...
export function PromptsSection() {
	const { prompts, isLoading, error, loadItems, createPrompt, updatePrompt, deletePrompt } = usePromptStore();
