...
import { type ConceptFormData, useConceptStore } from '@/store/concept.store';
...
export function ConceptsSection() {
	const { concepts, isLoading, error, loadItems, createConcept, updateConcept, deleteConcept } = useConceptStore();
