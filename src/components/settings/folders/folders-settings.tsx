...
import { EmptyFoldersState } from './components/EmptyFoldersState';
import { ErrorCard, MemoizedErrorWrapper } from './components/ErrorCard';
import { FoldersGrid } from './components/FoldersGrid';
import { FoldersTable } from './components/FoldersTable';
import { GlobalReindexProgress } from './components/GlobalReindexProgress';
...
import { createHierarchicalOrderPure } from './utils/create-hierarchical-order';
					...
					<div className="flex items-center justify-between p-4">
						...
						{globalReindexStatus.isProcessing && (
							...
							<GlobalReindexProgress
								...
								isGloballyProcessing={globalReindexStatus.isProcessing}
								processStatus={globalReindexStatus}
							/>
							</div>
						)}
