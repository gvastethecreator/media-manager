...
import { SettingsIcon, BlocksIcon, Grid2X2Icon, TagIcon, UserIcon, BoxIcon, MapPinIcon, AlbumIcon, KeyboardIcon } from "lucide-react";
	...
	return (
		<div className="p-0 m-0 h-full w-full rounded-none">
			<ScrollArea className="h-full">
				...
				>
					<TabsList className="grid w-full grid-cols-11 h-9 py-0 px-2 m-0 rounded-none">
						...
						<TabsTrigger value="shortcuts">
							<KeyboardIcon className="h-4 w-4 mr-2" /> Atajos
						</TabsTrigger>
					</TabsList>
