...
export function SettingsView() {
	...
	const tabBaseStyles = cn(
		...
		"text-[11px] font-medium border-b-2 border-transparent",
		...
		<div className="p-0 m-0 h-full w-full rounded-none flex flex-col">
			...
			>
				...
				<div className="sticky top-0 z-10 bg-background shadow-sm">
					<TabsList className="flex w-full rounded-none bg-background justify-start border-b border-border overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
						{tabsData.map((tab) => (
							<TabsTrigger
								key={tab.id}
								value={tab.id}
				...
				<div className="flex-1 overflow-hidden">
					<TabsContent
						value="system"
						className="gap-2 px-2 h-full overflow-auto"
					>
					...
					<TabsContent value="albums" className="px-2 h-full overflow-auto">
						<AlbumsSection />
					</TabsContent>
					...
					<TabsContent value="tags" className="px-2 h-full overflow-auto">
						<TagsSection />
					</TabsContent>

					<TabsContent value="characters" className="px-2 h-full overflow-auto">
						<CharactersSection />
					</TabsContent>
					...
					<TabsContent value="places" className="px-2 h-full overflow-auto">
						<PlacesSection />
					</TabsContent>

					<TabsContent value="concepts" className="px-2 h-full overflow-auto">
						<ConceptsSection />
					</TabsContent>

					<TabsContent value="prompts" className="px-2 h-full overflow-auto">
						<PromptsSection />
					</TabsContent>

					<TabsContent value="notes" className="px-2 h-full overflow-auto">
						<NotesSection />
					</TabsContent>

					<TabsContent
						value="thumbnails"
						className="space-y-4 px-1 pt-1 h-full overflow-auto"
					>
						<ThumbnailsSection />
					</TabsContent>
					...
					<TabsContent value="objects" className="px-2 h-full overflow-auto">
