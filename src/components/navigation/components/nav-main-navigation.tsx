	...
	const NAVIGATION_CATEGORIES = [
		{
			...
			icon: Folder,
			children: [
				{ id: 'folders', label: 'Explorar carpetas', icon: Folder, count: stats.totalFolders || 0, color: '#F59E0B' },
			],
		},
		{
			id: 'files',
			...
			icon: Files,
			children: [
				{ id: 'files', label: 'Todos los archivos', icon: FileStack, count: stats.totalImages || 0, color: '#3B82F6' },
		...
		},
		{
			...
			icon: Layers,
			children: [
				{ id: 'favorites', label: 'Favoritos', icon: Star, count: stats.totalFavorites || 0, color: '#A21CAF' },
