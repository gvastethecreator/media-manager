 ...
 */
export function serializeWorldItemAttributes(
	attributes: { items: Array<{ name: string; value: number; maxValue?: number }> } | null
): string {
 ...
 */
export function deserializeWorldItemAttributes(attributesJson: string | null): {
	items: Array<{ name: string; value: number; maxValue?: number }>;
} {
 ...
 */
export function serializeWorldItemEffects(
	effects: { items: Array<{ name: string; description: string; duration?: string; cooldown?: string }> } | null
): string {
	if (!effects) return '{}';
	try {
 ...
 */
export function deserializeWorldItemEffects(effectsJson: string | null): {
	items: Array<{ name: string; description: string; duration?: string; cooldown?: string }>;
} {
 ...
 */
export function serializeWorldItemRequirements(
	requirements: { items: Array<{ name: string; value: number; description?: string }> } | null
): string {
 ...
 */
export function deserializeWorldItemRequirements(requirementsJson: string | null): {
 ...
 */
export function serializeWorldItemStats(
	stats: { items: Array<{ name: string; value: number; modifier?: string }> } | null
): string {
	if (!stats) return '{}';
	try {
 ...
 */
export function deserializeWorldItemStats(statsJson: string | null): {
	items: Array<{ name: string; value: number; modifier?: string }>;
} {
 ...
 */
export function serializeWorldItemProperties(
	properties: { items: Array<{ name: string; value: string | number | boolean; description?: string }> } | null
): string {
 ...
 */
export function deserializeWorldItemProperties(propertiesJson: string | null): {
	items: Array<{ name: string; value: string | number | boolean; description?: string }>;
} {
