...
import type { RelatedTag, Tag, TagComplete, TagCreateInput, TagSearchOptions, TagUpdateInput } from '@/types/entities/tag/types';
 ...
 */
export async function findManyTags(options: TagSearchOptions = {}): Promise<{ items: TagComplete[]; total: number; hasMore: boolean }> {
  try {
