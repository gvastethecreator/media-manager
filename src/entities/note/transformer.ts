...
import type { CreateNoteData, Note, NoteComplete, NoteSearchOptions, UpdateNoteData } from '@/types/entities/note/types';
 ...
 */
export async function findManyNotes(options: NoteSearchOptions = {}): Promise<{ items: NoteComplete[]; total: number; hasMore: boolean }> {
  try {
