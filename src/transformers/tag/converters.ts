 ...
 * @module transformers/tag/converters
 ...
 */
export function mapCompleteToTag(tagComplete: TagComplete): TagBase {
	try {
 ...
 */
export function tagToDisplayObject(tag: TagBase | TagComplete) {
	try {
		return {
			id: tag.id,
			name: tag.name,
