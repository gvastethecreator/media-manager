...
export function serializeFolderWithStats(folder: FolderWithStats): Record<string, any> {
	return {
		...
		stats: {
			...
			totalAudio: folder.stats.totalAudio,
			totalOthers: folder.stats.totalOthers,
			folderCount: folder.stats.folderCount,
			totalFolders: folder.stats.totalFolders,
			totalImages: folder.stats.totalImages,
			totalVideos: folder.stats.totalVideos,
			totalDocuments: folder.stats.totalDocuments,
			totalFiles: folder.stats.totalFiles,
			totalSize: folder.stats.totalSize,
