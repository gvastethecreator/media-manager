 ...
 */
export function transformGroupToDrizzle(prismaGroup: PrismaTypes.Group): DrizzleTypes.GroupEntity {
	return {
		id: prismaGroup.id,
 ...
 */
export function transformPropertyToDrizzle(prismaProperty: PrismaTypes.Property): DrizzleTypes.PropertyEntity {
	return {
 ...
 */
export function transformWildcardToDrizzle(prismaWildcard: PrismaTypes.Wildcard): DrizzleTypes.WildcardEntity {
	return {
 ...
 */
export function transformQueueJobToDrizzle(prismaQueueJob: PrismaTypes.QueueJob): DrizzleTypes.QueueJobEntity {
	return {
		id: prismaQueueJob.id,
		queue: prismaQueueJob.queue,
		data: typeof prismaQueueJob.data === 'string' ? prismaQueueJob.data : JSON.stringify(prismaQueueJob.data),
