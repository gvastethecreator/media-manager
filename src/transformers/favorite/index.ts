...
export {
    ...
    groupFavoritesByTypeMapper as groupFavoritesByType, mapCreateFavoriteDataToPrisma,
    mapUpdateFavoriteDataToPrisma,
    toFavoriteExtended,
    toFavoriteWithImage,
    toFavoritesWithImages, transformFavorite, transformFavoriteToExtended, transformFavorites, transformImageToFileItem
};
