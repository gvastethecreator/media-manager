// @ts-nocheck
/* Archivo backup obsoleto: contenido neutralizado.
 * Mantener solo un export de marcador.
 */
/*
...
throw new Error(`Unsupported entity type: ${entityType}`);
			...
			console.log(`🔍 FileEntityMapper: Iniciando extracción de metadata para $
{
	fileInfo.path;
}
`);
...
`);
				...
				if (metadataResult.success) {
					console.log(`;
✅ Metadata extraída exitosamente para: $
{
	fileInfo.path;
}
`, {
					...
					console.warn(`;
⚠️ No se pudo extraer metadata de $
{
	fileInfo.path;
}
