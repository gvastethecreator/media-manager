...
import type {
  OperationType,
  ProgressOperation, ProgressInfo,
  ItemsInfo,
  SizeInfo
...
export interface ProgressCallback {
  (operation: ProgressOperation): void;
}
...
class ProgressTrackingService extends SimpleEventEmitter {
  ...
  updateProgress(
    ...
    if (toastId) {
      ...
      const etaText = estimatedTimeRemaining ?
        ` - ${this.formatTimeRemaining(estimatedTimeRemaining)} restante` : '';
