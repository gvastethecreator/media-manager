...
/**
 * Genera una lista de archivos mock para pruebas
 * @param count Número de archivos a generar (por defecto 50)
 * @returns Lista de archivos mock
 */
export function generateMockFiles(count = 50): FileItem[] {
  ...
  for (let i = 0; i < count; i++) {
    ...
    files.push({ ...baseFile, ...specificProps } as FileItem)
  }

  return files
}

// Exportar archivos mock generados
