...
export const PREDEFINED_TEMPLATES: Record<string, PromptTemplate> = {
  ...
  character_creation: {
    ...
    content: 'Crea un personaje con las siguientes características:\n\n' +
      'Nombre: {{nombre}}\n' +
      'Género: {{genero}}\n' +
      'Edad: {{edad}}\n' +
      'Ocupación: {{ocupacion}}\n' +
  ...
  image_description: {
    ...
    content: 'Describe la siguiente imagen con gran detalle, incluyendo:\n' +
  ...
  code_generator: {
    ...
    model: PromptModel.GPT_4,
    content: 'Genera código {{lenguaje}} que cumpla con los siguientes requisitos:\n\n' +
      '{{requisitos}}\n\n' +
    ...
    exampleVariables: {
      lenguaje: 'TypeScript',
      requisitos: 'Crear una función que ordene un array de objetos por una propiedad específica, con soporte para ordenación ascendente y descendente.',
      estilo: 'Funcional',
      comentarios: true
    },
