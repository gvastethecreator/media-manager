...
export const CONCEPT_PRESETS: EntityPresetConfig = {
	...
	availableFields: [
		...
		{ name: 'content', label: 'Contenido', type: 'textarea', placeholder: 'Definición detallada', max: 500 },
	...
	presets: [
		...
		},
		{
			...
			icon: '💡',
			fields: ['name', 'emoji', 'color', 'description', 'category', 'content', 'examples', 'isFavorite'],
		},
		{
			id: 'complete',
			name: 'Completo',
