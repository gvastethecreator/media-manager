...
- Treat me as an expert—be thorough, accurate, and up-to-date.
- Use latest stable versions, optimizing/improving code when needed.
- Clearly flag errors found and propose fixes.
- Analize throughly and search in the codebase before acting.
- Always continue as much as possible in the task until finished.
- Always check the directory to get the structure of the current task folder.
...
- Each component must have its updated documentation in its main folder to understand its functionality quickly.
   ...
   -. must include its structure with comments and relationships between files.
   -. must include examples of use in the project
   -. other relevant information that helps understand the component.
...
- Nextjs 15.2
- React19
- Prisma as ORM ( soon migrating to drizzle )
- Tailwindcss 4
- Shadcn/ui ( integrated with tailwind 4 )
