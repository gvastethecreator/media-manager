	...
	theme: {
		...
		extend: {
			colors: {
				...
				'dt-neutral': {
					50: 'var(--dt-neutral-50)',
					100: 'var(--dt-neutral-100)',
					200: 'var(--dt-neutral-200)',
					300: 'var(--dt-neutral-300)',
					400: 'var(--dt-neutral-400)',
					500: 'var(--dt-neutral-500)',
					600: 'var(--dt-neutral-600)',
					700: 'var(--dt-neutral-700)',
					800: 'var(--dt-neutral-800)',
					900: 'var(--dt-neutral-900)',
					950: 'var(--dt-neutral-950)',
				},
				'dt-primary': {
				...
				'dt-success': {
					...
					200: 'var(--dt-success-200)',
					300: 'var(--dt-success-300)',
					400: 'var(--dt-success-400)',
					500: 'var(--dt-success-500)',
					600: 'var(--dt-success-600)',
					700: 'var(--dt-success-700)',
					800: 'var(--dt-success-800)',
					900: 'var(--dt-success-900)',
				},
				'dt-warning': {
					50: 'var(--dt-warning-50)',
					100: 'var(--dt-warning-100)',
					200: 'var(--dt-warning-200)',
					300: 'var(--dt-warning-300)',
					400: 'var(--dt-warning-400)',
					500: 'var(--dt-warning-500)',
					600: 'var(--dt-warning-600)',
					700: 'var(--dt-warning-700)',
					800: 'var(--dt-warning-800)',
					900: 'var(--dt-warning-900)',
				},
				'dt-danger': {
					50: 'var(--dt-danger-50)',
					100: 'var(--dt-danger-100)',
					200: 'var(--dt-danger-200)',
					300: 'var(--dt-danger-300)',
					400: 'var(--dt-danger-400)',
					500: 'var(--dt-danger-500)',
					600: 'var(--dt-danger-600)',
					700: 'var(--dt-danger-700)',
					800: 'var(--dt-danger-800)',
					900: 'var(--dt-danger-900)',
				},
				// Tokens semánticos de UI
				'ui-success': {
					DEFAULT: 'var(--ui-success-bg)',
					hover: 'var(--ui-success-bg-hover)',
					border: 'var(--ui-success-border)',
					text: 'var(--ui-success-text)',
					'text-strong': 'var(--ui-success-text-strong)',
				},
				'ui-warning': {
					DEFAULT: 'var(--ui-warning-bg)',
					hover: 'var(--ui-warning-bg-hover)',
					border: 'var(--ui-warning-border)',
					text: 'var(--ui-warning-text)',
					'text-strong': 'var(--ui-warning-text-strong)',
				},
				'ui-error': {
					DEFAULT: 'var(--ui-error-bg)',
					hover: 'var(--ui-error-bg-hover)',
					border: 'var(--ui-error-border)',
					text: 'var(--ui-error-text)',
					'text-strong': 'var(--ui-error-text-strong)',
				},
				'ui-info': {
					DEFAULT: 'var(--ui-info-bg)',
					hover: 'var(--ui-info-bg-hover)',
					border: 'var(--ui-info-border)',
					text: 'var(--ui-info-text)',
					'text-strong': 'var(--ui-info-text-strong)',
				},
				// Entidades
				entity: {
					...
					file: 'var(--entity-file)',
					'file-3d': 'var(--entity-file-3d)',
