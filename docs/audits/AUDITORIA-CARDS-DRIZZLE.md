	...
	return (
		<ScrollArea className="h-full">
			<div className="container mx-auto p-6">
				...
				{items.length === 0 ? (
					<EmptyState description="Aún no has creado entidades." icon={EntityIcon} title="Sin entidades" />
				) : (
...
_Auditoría completada el 1 de septiembre de 2025_  
_Estado: IMPLEMENTACIÓN CRÍTICA COMPLETADA ✅_  
_Próximo: Expandir a Media y Organization cards_
