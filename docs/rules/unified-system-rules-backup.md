...
1. **Español** - Todas las respuestas, comentarios, documentación, etc. deben estar completamente en español.

2. **Windows** - Todos los comandos y rutas deben ser compatibles con Windows. Usar PowerShell Core (pwsh) como terminal por defecto.
...
11. **Filesystem MCP** - Usarlo cuando sea necesario, para operaciones con archivos antes que comandos de terminal. Usar siempre rutas de Windows con unidad en mayúscula (ej. `D:\`).
