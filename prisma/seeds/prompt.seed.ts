			...
			data: [
				{
					...
					content:
						'Full portrait of a [character type] with [distinguishing features], fantasy style, detailed clothing, [color scheme], dramatic lighting, [pose], fantasy background, high detail, trending on artstation',
					category: 'personajes',
				...
				},
				{
					...
					content:
						'Breathtaking [landscape type] landscape, [time of day], [weather conditions], [color palette], cinematic, ultra-detailed, epic scale, dramatic lighting, volumetric fog, 8k resolution, trending on artstation',
					category: 'paisajes',
					parameters: JSON.stringify({
						strength: 0.8,
						steps: 35,
				...
				},
				{
					...
					content:
						'Concept art of [subject], [art style], detailed environment, [atmosphere], professional quality, highly detailed, trending on artstation, by [famous artist]',
					category: 'arte',
					parameters: JSON.stringify({
						strength: 0.7,
						steps: 28,
				...
				},
				{
					...
					content:
						'Magical [object type], [material], intricate details, [color scheme], glowing runes, [magical effect], dark background, studio lighting, 4k, highly detailed',
					category: 'objetos',
					parameters: JSON.stringify({
						strength: 0.65,
						steps: 25,
				...
				},
				{
					...
					content:
						'Highly detailed fantasy [creature type], [distinctive features], [environment], dynamic pose, [lighting conditions], epic composition, cinematic, intricate details, 8k, by [artist style]',
					category: 'criaturas',
					parameters: JSON.stringify({
						strength: 0.72,
						steps: 32,
