			...
			const promptsData = [
				{
					...
					parameters: JSON.stringify({
						...
						negativePrompt:
							'deformed, anime style, cartoon, blurry, extra fingers, misaligned eyes, bad anatomy, distorted face, mutation, mutated, extra limbs, ugly, poorly drawn hands, missing limbs, floating limbs, disconnected limbs, malformed hands, blurry, out of focus',
						versions: [
							{
								name: 'Female Variant',
				...
				},
				{
					...
					parameters: JSON.stringify({
						...
						sampler: 'Euler a',
						negativePrompt:
							'dead trees, winter, snow, urban elements, human structures, paths, roads, modern elements, cartoonish, flat colors, low quality, blurry, noisy',
						versions: [
							{
								name: 'Night',
				...
				},
				{
					...
					parameters: JSON.stringify({
						...
						sampler: 'DPM++ 2M Karras',
						negativePrompt:
							'people, animals, text, watermark, low resolution, blurry, distortion, defocus, oversaturation, noise, grain, artifacts, signature, cropped, frame, border',
						versions: [
							{
								name: 'Winter',
				...
				},
				{
					...
					parameters: JSON.stringify({
						...
						sampler: 'DPM++ 2M Karras',
						negativePrompt:
							'cartoon, simple skeleton, zombie, excessive gore, exaggerated poses, bright colors, anime style, childish, clean armor, pristine condition, modern elements',
						versions: [
							{
								name: 'Battle',
				...
				},
				{
					...
					parameters: JSON.stringify({
						...
						sampler: 'DPM++ 2M Karras',
						negativePrompt:
							'simple fire effects, basic flames, modern clothing, cartoon style, bad anatomy, deformed, anime, chibi, poorly drawn face, extra limbs, text, watermark, signature, simple background',
						versions: [
							{
								name: 'Fire Ritual',
				...
				},
				{
					...
					parameters: JSON.stringify({
						...
						negativePrompt:
							'simple hole, normal colors, regular patterns, cartoon style, anime, childish, clean edges, symmetrical, basic shapes, flat colors, lack of depth',
						versions: [
							{
								name: 'Manifestation',
				...
				},
				{
					...
					parameters: JSON.stringify({
						...
						sampler: 'Euler a',
						negativePrompt:
							'simple snow, smooth ice, flat sky, modern buildings, urban elements, tropical elements, desert, summer, green vegetation, warm colors',
						versions: [
							{
								name: 'Blizzard',
