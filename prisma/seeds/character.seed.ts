      ...
      const characters = [
        {
          ...
          backstory: 'Antiguamente un noble guerrero, Aldric contrajo la maldición de la no-muerte y ahora recorre el mundo intentando romperla.',
        ...
        },
        {
          ...
          backstory: 'Exiliada de su tierra natal por practicar magia de fuego prohibida, vaga para perfeccionar su arte y controlar el poder que la consume.',
          stats: JSON.stringify({
            strength: 8,
            dexterity: 14,
            intelligence: 19,
        ...
        },
        {
          ...
          backstory: 'Buscando salvar a su reino del caos, se aventuró en el Abismo, pero salió marcado por fuerzas oscuras.',
          stats: JSON.stringify({
            strength: 20,
            dexterity: 15,
            intelligence: 13,
        ...
        },
        {
          ...
          race: 'Half-Orc',
          alignment: 'True Neutral',
          backstory: 'Garruk vaga por las tierras salvajes, asegurándose de que ninguna fuerza perturbe el orden natural.',
          stats: JSON.stringify({
            strength: 16,
            dexterity: 12,
            intelligence: 14,
