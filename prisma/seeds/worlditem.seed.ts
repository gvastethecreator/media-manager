			...
			data: [
				{
					...
					effects: JSON.stringify([
						'Inflinge 2d6 de daño de fuego adicional',
						'Ilumina 10 metros a la redonda',
						'Inmunidad al frío para el portador',
					]),
					size: 'medium',
				...
				},
				{
					...
					effects: JSON.stringify([
						'Resistencia a la magia necrótica',
						'Advertencia de peligro inminente',
						'Purifica agua contaminada una vez al día',
					]),
					size: 'small',
				...
				},
				{
					...
					effects: JSON.stringify([
						'Permite memorizar un hechizo adicional por nivel',
						'Proporciona ventaja en pruebas de Arcano',
						'Puede revelar información oculta bajo la luz correcta',
					]),
					size: 'medium',
				...
				},
				{
					...
					effects: JSON.stringify([
						'Vuelve invisible al usuario y lo que lleva',
						'Duración de 1 hora al día',
						'La invisibilidad se rompe al atacar',
					]),
					size: 'medium',
					requirements: 'Ninguno',
				...
				// Objetos de Aldric
				{
					...
					effects: JSON.stringify([
						'Inflige daño necrótico adicional',
						'Drena la vida de los objetivos',
						'Susurra pensamientos oscuros',
					]),
					size: 'medium',
				...
				},
				{
					...
					effects: JSON.stringify([
						'Protege contra ataques físicos',
						'Rechaza la magia de curación',
						'Mantiene unido al no-muerto',
					]),
					size: 'large',
				...
				// Objetos de Serafina
				{
					...
					effects: JSON.stringify([
						'Daño adicional contra no-muertos',
						'Puede canalizar magia de curación',
						'Brilla con luz sagrada',
					]),
					size: 'medium',
				...
				},
				{
					...
					emoji: '🧪',
					color: '#a3e635',
					description: 'Permite al usuario volverse invisible por 1 hora',
					shortcut: 'invisible-potion',
					category: 'consumibles',
					sortBy: 'rarity',
					filters: JSON.stringify(['type:potion', 'rarity:rare']),
					type: 'potion',
					rarity: 'rare',
					attributes: JSON.stringify(['effect:invisibility', 'duration:1h']),
					effects: JSON.stringify(['Desaparece de la vista de enemigos', 'No deja huellas']),
					size: 'small',
					requirements: 'Ninguno',
					origin: 'Creada por alquimistas del norte',
					stats: JSON.stringify({ duration: 60, value: 1200 }),
					featuredImage: null,
					isFavorite: false,
				},
			],
