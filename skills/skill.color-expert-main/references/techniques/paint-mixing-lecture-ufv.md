# Things to Know about Mixing Paint

**Source:** [Color Nerd](https://www.youtube.com/@ColorNerd1) (YouTube)
**Speaker:** Peter Donahue
**Date:** 2022-11-22
**URL:** https://www.youtube.com/watch?v=jLSCbbID1ck
**Duration:** 51:35
**Views:** 7,103
**Event:** Lecture for first-year painting students, University of the Fraser Valley

## Description

Practical lecture and live demo on paint mixing fundamentals. Covers hue, chroma, and lightness with hands-on acrylic mixing exercises. Shows why the traditional color wheel misleads beginners by misrepresenting color distances.
...
- Black similarly affects hue: black + yellow → olive/green (not dark yellow)
...
- Available free on Color Nerd's linktree
...
- **The Artist's Helper:** free app for plotting colors in CIE space (Bob Burridge)
- **Color Nerd's Color Disc:** free download via linktree
