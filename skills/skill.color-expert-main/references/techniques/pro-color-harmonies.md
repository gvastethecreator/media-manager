...
```typescript
import {
  clampOKLCH, normalizeHue, avoidMuddyZones,    // color utils
  getComplementaryHue, getTriadicHues,             // hue strategies
  lerp, lerpOKLCH,                                 // interpolation
  enhancePalette, polishPalette,                   // post-processing
