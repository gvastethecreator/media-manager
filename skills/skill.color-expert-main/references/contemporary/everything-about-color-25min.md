# Everything About Color in 25 Minutes

**Source:** [Juxtopposed](https://www.youtube.com/@juxtopposed) (YouTube)
**Date:** 2024-08-17
**URL:** https://www.youtube.com/watch?v=srRI7yMjGz0
**Duration:** 24:56
**Views:** 471,577

## Description

Comprehensive explainer covering the entire color pipeline: from physics of light through human perception, color spaces, photography, display technologies, color manipulation, and color psychology. Aimed at designers, 471K views.

## Topics Covered

### Physics of Color
- Color = reflected light; pigments absorb certain wavelengths, reflect others
- Newton's prism → 7 spectral colors = different wavelengths
- Subtractive mixing (RYB/CMY, pigments absorb from white light) vs additive mixing (RGB, adding light)

### Human Color Vision
- 3 cone types: S (short/blue), M (medium/green), L (long/red)
- Brain mixes signals → perceives colors that don't exist as single wavelengths (magenta, pink, brown, purple)
- Every eye is different → color is subjective (Goethe's critique of Newton)
- Opponent process theory: brain processes in 3 channels (green-red, blue-yellow, black-white)
- Color blindness: missing or anomalous cone cells
...
- 6-step color palette filter: industry fit → purpose → background/mode → saturation → harmony → contrast
- Realtime Colors website recommended for palette generation + testing

## Links

- **Realtime Colors:** https://realtimecolors.com
- **Color Gamuts comparison:** https://colorgamuts.com
- **Wide Gamut test:** https://wide-gamut.com
