...
),c._resetSlider=function(){document.getElementById(c.sliderId).value=c.defaultValue,c._update()},c._ease=function(e){return e},c.opacityArray=c.props.images.map((function(e,t){return t<=c.props.defaultValue/100*c.props.images.length?1:0})),c.opacities=c.props.defaultValue?c.opacityArray:3===c.props.images.length?[1,1,0]:[1,0],c.props.radio&&(c.opacities=[1,0,0]),c.defaultValue=c.props.defaultValue?c.props.defaultValue:3===c.props.images.length?50:0,c.labels=[c.props.labelLeft,c.props.labelCenter,c.props.labelRight],c.images=c.props.radio?e.images.map((function(e,t){return Object(b.jsx)(T,{className:

+c.labels[t],src:e,style:{left:0,height:c.height,opacity:0===t?1:0}},c.id+
...
(Alpha, transparency, translucency) Opacity is a property that describes how much you can see through a color.

Orange circle with arrow pointing to a lighter orange circle, demonstrating its Opacity

Opacity is a property that describes how much you can see through a color.
